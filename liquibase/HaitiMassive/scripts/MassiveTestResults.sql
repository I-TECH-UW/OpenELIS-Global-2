...
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Recherche de BAAR Auramine(Liquide Pleural)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='Pres BK' )  , now() , 531);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
...
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Recherche de BAAR Auramine(Liquide Pleural)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='1+' )  , now() , 533);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Recherche de BAAR Auramine(Liquide Pleural)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='2+' )  , now() , 534);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Recherche de BAAR Auramine(Liquide Pleural)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='3+' )  , now() , 535);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Recherche de BAAR Auramine(Liquide Pleural)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='etc' )  , now() , 536);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Recherche de BAAR Zielh Neelsen(Liquide Pleural)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='Pres BK' )  , now() , 537);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
...
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Recherche de BAAR Zielh Neelsen(Liquide Pleural)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='1+' )  , now() , 539);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Recherche de BAAR Zielh Neelsen(Liquide Pleural)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='2+' )  , now() , 540);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Recherche de BAAR Zielh Neelsen(Liquide Pleural)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='3+' )  , now() , 541);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Recherche de BAAR Zielh Neelsen(Liquide Pleural)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='etc' )  , now() , 542);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
...
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'B-HCG(Serum)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='' )  , now() , 589);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'B-HCG(Urine concentré du matin)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='' )  , now() , 590);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Test de Grossesse(Urines)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='Positif' )  , now() , 591);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Test de Grossesse(Urines)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='Negatif' )  , now() , 592);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'T4(Serum)' ) , 'N' , null , now() , 593);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
