...
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Recherche de Virus Respiratoire-A(Ecouvillon Naso-Pharynge)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='Influenza A H1N1v' )  , now() , 1950);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Recherche de Virus Respiratoire-A(Ecouvillon Naso-Pharynge)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='Influenza A H1N1s' )  , now() , 1960);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Recherche de Virus Respiratoire-A(Ecouvillon Naso-Pharynge)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='Influenza A H3N2s' )  , now() , 1970);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Recherche de Virus Respiratoire-A(Ecouvillon Naso-Pharynge)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='Influenza A H5N1' )  , now() , 1980);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Recherche de Virus Respiratoire-A(Ecouvillon Naso-Pharynge)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='Influenza A Negatif' )  , now() , 1990);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Recherche de Virus Respiratoire-B(Ecouvillon Naso-Pharynge)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='Influenza B Positif' )  , now() , 1990);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Recherche de Virus Respiratoire-B(Ecouvillon Naso-Pharynge)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='Influenza B Negatif' )  , now() , 1980);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
