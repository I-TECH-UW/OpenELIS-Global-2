INSERT INTO test_code( test_id, code_type_id, value, lastupdated) 
	VALUES ( (select id from clinlims.test where description = 'Test rapide HIV 1 + HIV 2(Serum)' ), (select id from clinlims.test_code_type where schema_name = 'billingCode'), 'B 70', now() );
INSERT INTO test_code( test_id, code_type_id, value, lastupdated) 
	VALUES ( (select id from clinlims.test where description = 'Test rapide HIV 1 + HIV 2(Serum)' ), (select id from clinlims.test_code_type where schema_name = 'analyzeCode'), 'SI50', now() );
INSERT INTO test_code( test_id, code_type_id, value, lastupdated) 
	VALUES ( (select id from clinlims.test where description = 'Test rapide HIV 1 + HIV 2(Plasma)' ), (select id from clinlims.test_code_type where schema_name = 'billingCode'), 'B 70', now() );
INSERT INTO test_code( test_id, code_type_id, value, lastupdated) 
	VALUES ( (select id from clinlims.test where description = 'Test rapide HIV 1 + HIV 2(Plasma)' ), (select id from clinlims.test_code_type where schema_name = 'analyzeCode'), 'SI50', now() );
INSERT INTO test_code( test_id, code_type_id, value, lastupdated) 
	VALUES ( (select id from clinlims.test where description = 'Test rapide HIV 1 + HIV 2(Sang total)' ), (select id from clinlims.test_code_type where schema_name = 'billingCode'), 'B 70', now() );
INSERT INTO test_code( test_id, code_type_id, value, lastupdated) 
	VALUES ( (select id from clinlims.test where description = 'Test rapide HIV 1 + HIV 2(Sang total)' ), (select id from clinlims.test_code_type where schema_name = 'analyzeCode'), 'SI50', now() );
INSERT INTO test_code( test_id, code_type_id, value, lastupdated) 
...
INSERT INTO test_code( test_id, code_type_id, value, lastupdated) 
	VALUES ( (select id from clinlims.test where description = 'Transaminases GPT(Serum)' ), (select id from clinlims.test_code_type where schema_name = 'billingCode'), 'B 25', now() );
INSERT INTO test_code( test_id, code_type_id, value, lastupdated) 
	VALUES ( (select id from clinlims.test where description = 'Transaminases GPT(Serum)' ), (select id from clinlims.test_code_type where schema_name = 'analyzeCode'), 'SB74', now() );
INSERT INTO test_code( test_id, code_type_id, value, lastupdated) 
	VALUES ( (select id from clinlims.test where description = 'Transaminases G0T(Serum)' ), (select id from clinlims.test_code_type where schema_name = 'billingCode'), 'B 25', now() );
INSERT INTO test_code( test_id, code_type_id, value, lastupdated) 
	VALUES ( (select id from clinlims.test where description = 'Transaminases G0T(Serum)' ), (select id from clinlims.test_code_type where schema_name = 'analyzeCode'), 'SB75', now() );
INSERT INTO test_code( test_id, code_type_id, value, lastupdated) 
