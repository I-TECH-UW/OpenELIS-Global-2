...
UPDATE clinlims.test_result SET tst_rslt_type='', sort_order=260
...
UPDATE clinlims.test_result SET tst_rslt_type='N', sort_order=460
	WHERE test_id= ( select id from clinlims.test where description = 'α1 globuline(Serum)' );
UPDATE clinlims.test_result SET tst_rslt_type='N', sort_order=470
	WHERE test_id= ( select id from clinlims.test where description = 'α2 globuline(Serum)' );
UPDATE clinlims.test_result SET tst_rslt_type='N', sort_order=480
	WHERE test_id= ( select id from clinlims.test where description = 'β globuline(Serum)' );
UPDATE clinlims.test_result SET tst_rslt_type='N', sort_order=490
	WHERE test_id= ( select id from clinlims.test where description = 'ϒ globuline(Serum)' );
...
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Chlorures(Plasma heparin�)' ) , 'N' , null , now() , 510);
...
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'Malaria(Sang)' ) , 'M' ,  ( select max(id) from clinlims.dictionary where dict_entry ='P. falciparum; P. vivax' )  , now() , 2110);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
...
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'FSH(Plasma heparin�)' ) , 'N' , null , now() , 3210);
...
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'LH(Plasma heparin�)' ) , 'N' , null , now() , 3230);
...
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'B-HCG(Urine concentr� du matin)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='Positif' )  , now() , 3280);
INSERT INTO test_result( id, test_id, tst_rslt_type, value , lastupdated, sort_order)
	 VALUES ( nextval( 'test_result_seq' ) , ( select id from clinlims.test where description = 'B-HCG(Urine concentr� du matin)' ) , 'D' ,  ( select max(id) from clinlims.dictionary where dict_entry ='Negatif' )  , now() , 3290);
