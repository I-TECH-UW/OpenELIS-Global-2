...
3. Access the application at [https://localhost/](https://localhost/). The
   legacy UI and the REST base sit under
   [https://localhost/api/OpenELIS-Global/](https://localhost/api/OpenELIS-Global/)
