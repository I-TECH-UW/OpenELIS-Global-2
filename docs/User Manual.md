...
_Click on Immunohistochemistry Drop-down Menu_



3. ** **Click on **Dashboard** sub-menu item.
...
_Default Hide Report Parameter_
...
_Select Epithelial Cell Abnormality Drop-down Menu_
...
_Click on Non-Conform Drop-down Menu_



3. ** **Click on **Report Non-Conforming Event** sub-menu item.
...
IMPORTANT: If you select **Lab Unit**, all tests not yet resulted in that unit are displayed. If you select by **Patient **or by **Lab Number, _<span style="text-decoration:underline;">all </span>_**tests for that patient or laboratory order will be displayed, including tests that already have results entered. 



<p id="gdcalert306" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image306.png). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert307">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
...
7. For _<span style="text-decoration:underline;">valid results</span>_, enter any comments for the patient or provider that should accompany the test results. These comments will appear on the patient report.  For _<span style="text-decoration:underline;">invalid results</span>_, enter any comments for the lab technician regarding the validation of results and any required follow-up. These comments appear only for the lab and do not appear on the patient report. 
...
6. For _<span style="text-decoration:underline;">valid results</span>_, enter any comments for the patient or provider that should accompany the test results. These comments will appear on the patient report.  For _<span style="text-decoration:underline;">invalid results</span>_, enter any comments for the lab technician regarding the validation of results and any required follow-up. These comments appear only for the lab and do not appear on the patient report. 
...
<table>
  ...
  <tr>
   <td>Individual Patient Report
   </td>
   <td>Patient Test Results Report
<p>
“Patient Status Report”
   </td>
  </tr>
  <tr>
   <td rowspan="2" >Aggregate Report
   </td>
   <td>Summary of All Tests
   </td>
  </tr>
  <tr>
   <td>Summary of HIV test
   </td>
  </tr>
  <tr>
   <td rowspan="3" >Management Report 
   </td>
   <td>Activity Reports
   </td>
  </tr>
  <tr>
   <td>Referred Tests Report
<p>
Non Conformity Events Report
   </td>
  </tr>
  <tr>
   <td>Delayed Validation Report
<p>
Audit Trail Report
   </td>
  </tr>
...
_Click on Report dropdown Menu_
...
_Click Patient Status Report Drop-down Menu_
...
6. For _<span style="text-decoration:underline;">a single laboratory order: </span>_Enter or scan the laboratory number in the **From **field.
...
8. For _<span style="text-decoration:underline;">a contiguous range of laboratory orders by number: </span>_Enter or scan the starting laboratory number in the **From **field and enter or scan the ending laboratory number in the **To **field. 
...
10. For _<span style="text-decoration:underline;">a single patient’s entire order history: </span>_Enter the **Patient ID  **in the **From **field. 
...
3. Click on either** Routine **or **Study.**
...
![alt_text](images/image404.png "image_tooltip")


_Click Drop-down Menu_
...
![alt_text](images/image419.png "image_tooltip")
...
![alt_text](images/image421.png "image_tooltip")
