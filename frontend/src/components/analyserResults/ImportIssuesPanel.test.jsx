...
describe("ImportIssuesPanel", () => {
  ...
  it("shows unmatched analyzer events with failure context and a supported analyzer results path", async () => {
    renderPanel();
    ...
    expect(
      screen.getByRole("link", { name: "Open analyzer results" }),
    ).toHaveAttribute("href", "/AnalyzerResults?id=77");
    expect(
