...
function CytologyDashboard() {
  ...
  const assignCurrentUserAsTechnician = (event, pathologySampleId) => {
    postToOpenElisServerFullResponse("/rest/cytology/assignTechnician?cytologySampleId=" + pathologySampleId, {}, refreshItems)
  }

  const assignCurrentUserAsPathologist = (event, pathologySampleId) => {
    postToOpenElisServerFullResponse("/rest/cytology/assignCytoPathologist?cytologySampleId=" + pathologySampleId, {}, refreshItems)
  }
  ...
  const refreshItems = () => {
    getFromOpenElisServer("/rest/cytology/dashboard?" + filtersToParameters(), setPathologyEntriesWithIds);
  }
