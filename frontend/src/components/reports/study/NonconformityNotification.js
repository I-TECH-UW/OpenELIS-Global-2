...
import { Grid, Column, Section, Button, Form, FormLabel, SelectItem } from "@carbon/react";
...
const breadcrumbs = [
    ...
    { label: "routine.reports", link: "/RoutineReports" },
    {
      ...
      link: "/RoutineReport?type=patient&report=retroCInonConformityNotification",
    },
  ];
 ...
 const handlePrinting = () => {
  ...
  setLoading(true);
  const baseParams = "report=retroCInonConformityNotification&type=patient";
      ...
      <Form onSubmit={handlePrinting}>
        ...
        <Grid fullWidth={true}>
          <Column lg={8} md={4} sm={2}>
            ...
            {/* InlineNotification can be replaced or added as per requirement */
            <p>
			...
			<br/>
            Entering a laboratory number will print a notification even if has already been printed. 
