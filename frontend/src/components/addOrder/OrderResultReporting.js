...
const PatientEmailAndSMS = (testId, index, handlePatientEmailAndSMS) => {
    ...
    return (<>
        <CustomCheckBox id={"patientEmail_" + index + "_" + testId}
                        onChange={(checked) => handlePatientEmail(checked)}
                        label="Email"/>
        <CustomCheckBox id={"patientSMS_" + index + "_" + testId}
...
const RequesterEmailAndSMS = (testId, index, handleRequesterEmailAndSMS) => {
    ...
    return (<>
        <CustomCheckBox id={"providerEmail_" + index + "_" + testId}
                        onChange={(checked) => handleProviderEmail(checked)}
                        label="Email"/>
        <CustomCheckBox id={"providerSMS_" + index + "_" + testId}
...
const OrderResultReporting = (props) => {
    ...
    const headers = ['', <FormattedMessage id="patient.label"/>,<FormattedMessage id="requester.label"/> ];
    let rows = [];
    props.selectedTests.map((test, index) => {
        ...
        rows.push({
            ...
            patientEmailAndSMS: PatientEmailAndSMS(testId, index, handlePatientEmailAndSMS),
            requesterEmailAndSMS: RequesterEmailAndSMS(testId, index, handleRequesterEmailAndSMS)
        });
    });
        ...
        switch (type) {
            case "PatientSMS":
                if (checked) {
                    ...
                    setNotificationTestIds({
                        ...notificationTestIds, patientSMSNotificationTestIds: updatedSMSNotificationIds
                    });
                }
                break;
            case "PatientEmail":
                if (checked) {
                    ...
                    setNotificationTestIds({
                        ...notificationTestIds, patientEmailNotificationTestIds: updatedEmailNotificationIds
                    });
                }
                break;
        }
        ...
        switch (type) {
            case "RequesterSMS":
                if (checked) {
                    ...
                    setNotificationTestIds({
                        ...notificationTestIds, providerSMSNotificationTestIds: updatedSMSNotificationIds
                    });
                }
                break;
            case "RequesterEmail":
                if (checked) {
                    ...
                    setNotificationTestIds({
                        ...notificationTestIds, providerEmailNotificationTestIds: updatedEmailNotificationIds
                    });
                }
                break;
        }
