...
const TEST_SECTION_ENDPOINT = "/rest/TestSectionRenameEntry";
...
function TestSectionRenameEntry() {
  ...
  const entityName = "testSection";
  const [selectedItem, setSelectedItem] = useState({});

  const invalidateServerData = useInvalidateServerData();
  const { data: testSectionName } = useServerData(TEST_SECTION_ENDPOINT);
  const testSectionListShow = testSectionName?.testSectionList ?? [];
