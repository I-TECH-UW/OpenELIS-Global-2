  ...
  return (
    ...
    >
      ...
      >
        <>
          <Router>
            {/* The signed-out routes render without Layout, and Layout is a
                lazy import, so reaching the login form does not download the
                header, its search, or anything the shared chunk drags with it. */}
