...
public class FieldChecks extends org.apache.struts.validator.FieldChecks {
	 ...
	 * '2/12/1999' will not pass validation with the format 'MM/dd/yyyy' because the
	 * month isn't two digits. If no datePattern variable is specified, then the
	 * field gets the DateFormat.SHORT format for the locale. The setLenient method
	 * is set to <code>false</code> for all variations.
	 *
	...
	public static Object validateDate(Object bean, ValidatorAction va, Field field, ActionMessages errors,
		...
		String datePatternForResources = MessageUtil.getMessage(datePattern);
		if (datePatternForResources != null) {
			datePattern = datePatternForResources;
		}

		datePatternForResources = MessageUtil.getMessage(datePatternStrict);
		if (datePatternForResources != null) {
