...
@Controller
public class CancelDictionaryMenuController extends BaseController {
  @RequestMapping(
      value = "/CancelDictionaryMenu",
      method = RequestMethod.GET
  )
  public ModelAndView showCancelDictionaryMenu(HttpServletRequest request) {
