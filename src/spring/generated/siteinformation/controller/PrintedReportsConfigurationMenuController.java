...
@Controller
public class PrintedReportsConfigurationMenuController extends BaseController {
  @RequestMapping(
      value = "/PrintedReportsConfigurationMenu",
      method = RequestMethod.GET
  )
  public ModelAndView showPrintedReportsConfigurationMenu(HttpServletRequest request) {
