...
@Controller
public class NextPreviousResultConfigurationController extends BaseController {
  @RequestMapping(
      value = "/NextPreviousResultConfiguration",
      method = RequestMethod.GET
  )
  public ModelAndView showNextPreviousResultConfiguration(HttpServletRequest request) {
