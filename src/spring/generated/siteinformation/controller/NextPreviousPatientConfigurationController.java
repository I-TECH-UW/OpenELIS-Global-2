...
@Controller
public class NextPreviousPatientConfigurationController extends BaseController {
  @RequestMapping(
      value = "/NextPreviousPatientConfiguration",
      method = RequestMethod.GET
  )
  public ModelAndView showNextPreviousPatientConfiguration(HttpServletRequest request) {
