...
@Controller
public class UpdateNextPreviousResultConfigurationController extends BaseController {
  @RequestMapping(
      value = "/UpdateNextPreviousResultConfiguration",
      method = RequestMethod.GET
  )
  public ModelAndView showUpdateNextPreviousResultConfiguration(HttpServletRequest request) {
