...
@Controller
public class WorkplanConfigurationMenuController extends BaseController {
  @RequestMapping(
      value = "/WorkplanConfigurationMenu",
      method = RequestMethod.GET
  )
  public ModelAndView showWorkplanConfigurationMenu(HttpServletRequest request) {
    String forward = FWD_SUCCESS;
    WorkplanConfigurationMenuForm form = new WorkplanConfigurationMenuForm();
