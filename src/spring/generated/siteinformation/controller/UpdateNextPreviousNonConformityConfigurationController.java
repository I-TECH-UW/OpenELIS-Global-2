...
@Controller
public class UpdateNextPreviousNonConformityConfigurationController extends BaseController {
  @RequestMapping(
      value = "/UpdateNextPreviousNonConformityConfiguration",
      method = RequestMethod.GET
  )
  public ModelAndView showUpdateNextPreviousNonConformityConfiguration(HttpServletRequest request) {
