...
@Controller
public class NonConformityConfigurationMenuController extends BaseController {
  @RequestMapping(
      value = "/NonConformityConfigurationMenu",
      method = RequestMethod.GET
  )
  public ModelAndView showNonConformityConfigurationMenu(HttpServletRequest request,
      @ModelAttribute("form") NonConformityConfigurationMenuForm form) {
