package spring.generated.qaevent.controller;
...
import spring.generated.forms.NonConformityForm;
...
public class NonConformityUpdateController extends BaseController {
  ...
  public ModelAndView showNonConformityUpdate(HttpServletRequest request) {
    ...
    form.setFormName("NonConformityForm");
    form.setFormAction("");
  ...
  protected ModelAndView findLocalForward(String forward, BaseForm form) {
    if ("success".equals(forward)) {
      return new ModelAndView("/NonConformity.do?forward=success", "form", form);
