...
public class ResultsReportSampleComparator implements Comparable {
   ...
   public int compareTo(Object obj) {
      ...
      String concatenatedSortField = (getLongVersionOfNumber(sample.getOrganizationId()) + getLongVersionOfNumber(sample.getAccessionNumber()));
   ...
   public static final Comparator VALUE_COMPARATOR =
     new Comparator() {
      public int compare(Object a, Object b) {
    	  ...
    	  String sample_aConcatenatedSortField = (getLongVersionOfNumber(sample_a.getOrganizationId()) + getLongVersionOfNumber(sample_a.getAccessionNumber()));
       	  String sample_bConcatenatedSortField = (getLongVersionOfNumber(sample_b.getOrganizationId()) + getLongVersionOfNumber(sample_b.getAccessionNumber()));
