...
public interface QaObservationDAO extends BaseDAO {
	...
	public QaObservation getQaObservationByTypeAndObserved(String typeName, String observedType, String observedId) throws LIMSRuntimeException;
}
