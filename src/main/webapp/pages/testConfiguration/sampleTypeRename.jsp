...
<bean:define id="typeList" name='${form.formName}' property="sampleTypeList" type="java.util.List"/>
...
<form:hidden path="sampleTypeId" name="${form.formName}" id="sampleTypeId"/>
