...
public class UnifiedSystemUserForm extends BaseForm {
  ...
  /**
   * There are multiple fields in the ui-form mapped to this field, because the ui-form can
   * dynamically create more fields mapped to this same field(path), this field is only used to get
   * values from the form as a single String with comma ,separated values ie "value1 ,value2"
   */
   ...
   * There are multiple fields in the ui-form mapped to this field, because the ui-form can
   * dynamically create more fields mapped to this same field(path), this field is only used to get
   * values from the form as a List of Strings
   */
  ...
  /**
   * This field passes the user Lab Unit Roles data to the ui-form in form of a json object , in
   * order to dynamically render sets of Lab Unit Roles with data ,with fields that are mapped to
   * the same path ie testSectionId and selectedLabUnitRoles
   */
