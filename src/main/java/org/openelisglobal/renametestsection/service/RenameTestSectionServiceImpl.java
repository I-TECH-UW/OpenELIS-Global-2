...
@Service
public class RenameTestSectionServiceImpl
    extends AuditableBaseObjectServiceImpl<RenameTestSection, String>
    implements RenameTestSectionService {
  @Autowired protected RenameTestSectionDAO baseObjectDAO;
  ...
  public Localization getLocalizationForRenameTestSection(String id) {
    ...
    Localization localization =
        renameTestSection != null ? renameTestSection.getLocalization() : null;
