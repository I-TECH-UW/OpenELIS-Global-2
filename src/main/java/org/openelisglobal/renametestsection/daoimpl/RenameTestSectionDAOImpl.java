...
@Component
@Transactional
public class RenameTestSectionDAOImpl extends BaseDAOImpl<RenameTestSection, String>
    implements RenameTestSectionDAO {
  ...
  public void getData(RenameTestSection testSection) throws LIMSRuntimeException {
    try {
      RenameTestSection uom =
          entityManager.unwrap(Session.class).get(RenameTestSection.class, testSection.getId());
  ...
  public List<RenameTestSection> getAllTestSections() throws LIMSRuntimeException {
    ...
    try {
      ...
      Query<RenameTestSection> query =
          entityManager.unwrap(Session.class).createQuery(sql, RenameTestSection.class);
  ...
  public RenameTestSection getTestSectionById(String testSectionId) throws LIMSRuntimeException {
    try {
      RenameTestSection ts =
          entityManager.unwrap(Session.class).get(RenameTestSection.class, testSectionId);
      return ts;
    } catch (RuntimeException e) {
  ...
  // bugzilla 1482
  @Override
  public boolean duplicateTestSectionExists(RenameTestSection testSection)
      throws LIMSRuntimeException {
    try {
      ...
      // duplicates
      String sql =
          "from TestSection t where trim(lower(t.testSectionName)) = :param and t.id != :param2";
      Query<RenameTestSection> query =
          entityManager.unwrap(Session.class).createQuery(sql, RenameTestSection.class);
