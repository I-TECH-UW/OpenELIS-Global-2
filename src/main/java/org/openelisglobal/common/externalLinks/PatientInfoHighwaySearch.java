...
public class PatientInfoHighwaySearch implements IExternalPatientSearch {
  ...
  private enum InfoHighwayField {
    CITIZEN_NIC_NUMBER("CITIZEN.NIC_NUMBER"),
    CITIZEN_SURNAME("CITIZEN.SURNAME"),
  ...
  private void setPossibleErrors() {
    switch (returnStatus) {
      ...
      default:
        {
          errors.add(
              "Unknown error trying to connect to patient information service. Return status was "
                  + returnStatus);
        }
    }
  }
  ...
  private void addSearchParamIfNotBlank(
      String fieldValue, InfoHighwayField field, SOAPElement soapQueryInputElem)
  ...
  private void changeDefaultSoapNamespace(
      SOAPEnvelope envelope, String soapPrefix, String soapNamespaceURI) throws SOAPException {
  ...
  private void processResponse(SOAPMessage soapResponse) throws SOAPException {
    ...
    QName bodyName =
        new QName("http://ws.server.mhaccess.crimsonlogic.com/", "queryResponse", "ns3");
  ...
  private void setDate(ExtendedPatientSearchResults patient, String dateString)
      throws ParseException {
