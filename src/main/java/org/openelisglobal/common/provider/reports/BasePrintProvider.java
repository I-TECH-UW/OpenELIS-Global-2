...
public abstract class BasePrintProvider implements IActionConstants {
  ...
  // bugzilla 1856
  protected void moveParentTestsOfCurrentTestsFromPreviouslyReportedTests(
      List<ResultsReportTest> currentTests, List<?> previouslyReportedTests) {
  ...
  // bugzilla 1856
  private void recursiveMoveParentTests(
      ResultsReportTest test,
      List<ResultsReportTest> currentTests,
      List<ResultsReportTest> tempCurrentTests,
    ...
    while (it.hasNext()) {
      ...
      if (test.getAnalysis().getParentAnalysis() != null
          && test.getAnalysis()
              .getParentAnalysis()
              .getId()
              .equals(previousTest.getAnalysis().getId())) {
  ...
  private void recursiveHierarchyBuild(
      ResultsReportTest element, List<?> tests, List<ResultsReportTest> newTests) {
