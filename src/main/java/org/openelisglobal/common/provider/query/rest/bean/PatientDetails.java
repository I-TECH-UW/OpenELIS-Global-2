...
public class PatientDetails {
    ...
    public String getPatientUpdated() {
        return patientUpdated;
    }
    public void setPatientUpdated(String patientUpdated) {
        this.patientUpdated = patientUpdated;
    }
    public String getPersonUpdated() {
        return personUpdated;
    }
    public void setPersonUpdated(String personUpdated) {
