...
/**
 * This class will abstract the ValidationProvider creation. It will read the name of the class file
...
public class ValidationProviderFactory {
  ...
  private static class SingletonHelper {
    private static final ValidationProviderFactory INSTANCE =
        new ValidationProviderFactory(); // Instance of this
  }
  ...
  /**
   * Search for the ValidationProvider implementation class name in the Validation.properties file
   * for the given ValidationProvider name
   *
   * @param String ValidationProvider name e.g "OrganizationLocalAbbreviationValidationProvider"
   * @return String Full implementation class e.g "org.openelisglobal.common.validation.provider"
   */
  protected String getValidationProviderClassName(String validationProvidername)
