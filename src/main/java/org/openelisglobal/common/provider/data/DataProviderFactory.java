...
/**
 * This class will abstract the DataProvider creation. It will read the name of the class file from
 * properties file and create the class
 *
 * @version 1.0
...
public class DataProviderFactory {
  ...
  private static class SingletonHelper {
    private static final DataProviderFactory INSTANCE =
        new DataProviderFactory(); // Instance of this
  }
  ...
  /**
   * Search for the DataProvider implementation class name in the Data.properties file for the given
   * DataProvider name
   *
   * @param String DataProvider name e.g "NextTestSortOrderDataProvider"
   * @return String Full implementation class e.g "org.openelisglobal.common.data.provider"
   */
  protected String getDataProviderClassName(String dataProvidername) throws LIMSRuntimeException {
    ...
    if (mapping == null) {
      // bugzilla 2154
      //            LogEvent.logError(this.getClass().getSimpleName(), "getDataProviderClassName",
      // dataProvidername, e);
      throw new LIMSRuntimeException(
          "getDataProviderClassName - Unable to find mapping for " + dataProvidername);
    }
    return mapping;
  }
