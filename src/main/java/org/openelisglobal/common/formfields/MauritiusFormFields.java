...
public class MauritiusFormFields implements IFormFieldsForImplementation {
    ...
    public HashMap<FormFields.Field, FormField> getImplementationAttributes() {
        ...
        settings.put(Field.NON_CONFORMITY_SITE_LIST_USER_ADDABLE, new FormField(Boolean.FALSE));
        settings.put(Field.QaEventsBySection, new FormField(Boolean.TRUE));
        ...
        settings.put(Field.PatientHealthRegion, new FormField(Boolean.TRUE, "person.health.district"));
        settings.put(Field.PatientHealthDistrict, new FormField(Boolean.FALSE));
        ...
        settings.put(Field.NON_CONFORMITY_PROVIDER_ADDRESS, new FormField(Boolean.FALSE));
        settings.put(Field.QA_FULL_PROVIDER_INFO, new FormField(Boolean.TRUE));
        settings.put(Field.QASubjectNumber, new FormField(Boolean.FALSE));
        settings.put(Field.ADDRESS_COMMUNE, new FormField(Boolean.TRUE, "person.streetAddress.street"));
        settings.put(Field.ADDRESS_VILLAGE, new FormField(Boolean.TRUE, "person.townvillage"));
        settings.put(Field.SEARCH_PATIENT_WITH_LAB_NO, new FormField(Boolean.TRUE));
        settings.put(Field.SampleNature, new FormField(Boolean.TRUE));
        settings.put(Field.PatientEmail, new FormField(Boolean.TRUE));
