...
public class ValidationHelper {
  ...
  public static final String YES_NO_REGEX =
      "^$|^" + IActionConstants.YES + "$|^" + IActionConstants.NO + "$";
  ...
  public static void validateFieldRequired(
      String value, String name, String displayName, Errors errors) {
  ...
  public static void validateFieldLengthMax(
      String value, String name, String displayName, Errors errors, int max) {
    int length = 0;
    if (value != null) {
      length = value.length();
    }
    if (length > max) {
      errors.rejectValue(
          name,
          "error.field.length.long",
          new Object[] {displayName, Integer.toString(max)},
          DEFAULT_PREFIX + displayName + " has too many characters");
    }
  }

  public static void validateFieldLengthMin(
      String value, String name, String displayName, Errors errors, int min) {
    int length = 0;
    if (value != null) {
      length = value.length();
    }
    if (length < min) {
      errors.rejectValue(
          name,
          "error.field.length.short",
          new Object[] {displayName, Integer.toString(min)},
          DEFAULT_PREFIX + displayName + " has too few characters");
    }
  }

  public static void validateFieldMatchRegex(
      String value, String name, String displayName, Errors errors, String regex) {
  ...
  public static void validateFieldCharSet(
      String value, String name, String displayName, Errors errors, String charSet) {
    if (!GenericValidator.isBlankOrNull(value)) {
      if (!Pattern.matches("^[" + charSet + "]*$", value)) {
        String charsetForDisplay = charSet.replaceAll("\\\\(?!\\\\)", "");
        errors.rejectValue(
            name,
            "error.field.charset.invalid",
            new Object[] {displayName, charsetForDisplay},
            DEFAULT_PREFIX
                + displayName
                + " has an invalid character. Allowed characters are '"
                + charsetForDisplay
                + "'");
      }
    }
  ...
  public static void validateDateField(
      String value, String name, String displayName, Errors errors, DateRelation relative) {
    String result =
        CustomDateValidator.getInstance()
            .validateDate(CustomDateValidator.getInstance().getDate(value), relative);
    if (!IActionConstants.VALID.equals(result)) {
      errors.rejectValue(
          name,
          "error.field.date.invalid",
          new Object[] {displayName, result},
          DEFAULT_PREFIX + displayName + " is not in a valid date format");
    }
  }

  public static void validateTimeField(
      String value, String name, String displayName, Errors errors) {
    if (!CustomDateValidator.getInstance().validate24HourTime(value)) {
      errors.rejectValue(
          name,
          "error.field.time.invalid",
          new Object[] {displayName, value},
          DEFAULT_PREFIX + displayName + " is not in a valid time format");
    }
  }

  public static void validateOptionFieldIgnoreCase(
      String value, String name, String displayName, Errors errors, String[] possibleValues) {
    boolean match = false;
  ...
  public static void validateFieldLength(
      String value, String name, String displayName, Errors errors, int min, int max) {
  ...
  public static void validateFieldAndCharset(
      String value,
      String name,
      String displayName,
      Errors errors,
  ...
  public static void validateIdField(
      String value, String name, String displayName, Errors errors, boolean required) {
  ...
  public static void validateYNField(String value, String name, String displayName, Errors errors) {
    validateOptionField(
        value, name, displayName, errors, new String[] {IActionConstants.YES, IActionConstants.NO});
  }
  ...
  public static void validateGenderField(
      String value, String name, String displayName, Errors errors, boolean required) {
    if (required) {
  ...
  public static void validateFieldMatchRegex(
      String value, String name, Errors errors, String regex) {
    validateFieldMatchRegex(value, name, name, errors, regex);
  }

  public static void validateFieldCharSet(
      String value, String name, Errors errors, String charSet) {
    validateFieldCharSet(value, name, name, errors, charSet);
  }

  public static void validateFieldLength(
      String value, String name, Errors errors, int min, int max) {
    validateFieldLength(value, name, name, errors, min, max);
  }

  public static void validateField(
      String value, String name, Errors errors, boolean required, int maxLength) {
    validateField(value, name, name, errors, required, maxLength);
  }

  public static void validateField(
      String value, String name, Errors errors, boolean required, int maxLength, String regex) {
  ...
  public static void validateDateField(
      String value, String name, Errors errors, DateRelation relative) {
    validateDateField(value, name, name, errors, relative);
  }

  public static void validateDateField(
      String value, String name, Errors errors, DateRelation relative, boolean required) {
  ...
  public static void validateGenderField(
      String value, String name, Errors errors, boolean required) {
    validateGenderField(value, name, name, errors, required);
  }

  public static void validateOptionFieldIgnoreCase(
      String value, String name, Errors errors, String[] possibleValues) {
  ...
  public static void validateFieldMax(
      Integer value, String name, String displayName, Errors errors, int max) {
    if (value > max) {
      errors.rejectValue(
          name, "error.field.max", new String[] {displayName}, "Field too large an integer");
    }
  }

  public static void validateFieldMin(
      Integer value, String name, String displayName, Errors errors, int min) {
    if (value < min) {
      errors.rejectValue(
          name, "error.field.min", new String[] {displayName}, "Field too small an integer");
    }
  }

  public static void validateFieldMinMax(
      Integer value, String name, String displayName, Errors errors, int min, int max) {
  ...
  public static void validateFieldMinMax(
      Integer value, String name, Errors errors, int min, int max) {
  ...
  public static void validateFieldMax(
      Float value, String name, String displayName, Errors errors, float max) {
    if (value > max) {
      errors.rejectValue(
          name, "error.field.max", new String[] {displayName}, "Field too large a number");
    }
  }

  public static void validateFieldMin(
      Float value, String name, String displayName, Errors errors, float min) {
    if (value < min) {
      errors.rejectValue(
          name, "error.field.min", new String[] {displayName}, "Field too small a number");
    }
  }

  public static void validateFieldMinMax(
      Float value, String name, String displayName, Errors errors, float min, float max) {
    validateFieldMin(value, name, displayName, errors, min);
    validateFieldMax(value, name, displayName, errors, max);
  }
  ...
  public static void validateFieldMinMax(
      Float value, String name, Errors errors, float min, float max) {
    validateFieldMinMax(value, name, name, errors, min, max);
  }
  ...
  public static void validateTFField(
      Boolean value, String name, String displayName, Errors errors, boolean required) {
    Boolean[] options;
    if (required) {
  ...
  public static void validateOptionField(
      Object value, String name, String displayName, Errors errors, Object[] possibleValues) {
    boolean match = false;
  ...
  public static void validateOptionField(
      Object value, String name, Errors errors, Object[] possibleValues) {
