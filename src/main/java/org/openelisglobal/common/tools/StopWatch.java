...
public class StopWatch {
    ...
    /**
     * Starts the timer. If the timer is already running it will over-write the
     * start time and message and most likley make the existing marks meaningless.
     * To re-use an existing stopwatch call reset first.
     *
    ...
    /**
     * Resets the stopwatch. Start will need to be called again to start tracking
     * events
     */
    public void reset() {
        startMark = null;
    ...
    /**
     * Generates a report for the timings of the stop watch. The header from the
     * start method will be printed followed by each mark. Each mark will include
     * the accumulated time since the stopwatch started and the time since the last
     * mark.
     */
    public void report() {
        report(System.out);
    ...
    /**
     * Disables this stop watch. Convenient if you want to keep the timer in place
     * but don't want it to be active
     *
