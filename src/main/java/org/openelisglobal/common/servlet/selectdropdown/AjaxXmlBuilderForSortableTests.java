 ...
 *
 * <p>author: benzd1 bugzilla 1844: extending AjaxXmlBuilder for testsection->test select making
 * extended version of AjaxJspTag.Select sortable (toggle between sorting by 2 different properties,
...
public class AjaxXmlBuilderForSortableTests extends org.ajaxtags.helpers.AjaxXmlBuilder {
   ...
   * @return
   */
  public AjaxXmlBuilderForSortableTests addItem(
      String name, String value, String sortFieldA, String sortFieldB, String alternateLabel) {
   ...
   * @return
   */
  public AjaxXmlBuilderForSortableTests addItemAsCData(
      String name, String value, String sortFieldA, String sortFieldB, String alternateLabel) {
  ...
  public AjaxXmlBuilderForSortableTests addItems(
      ...
      String sortFieldAProperty,
      String sortFieldBProperty,
      String alternateLabelProperty)
