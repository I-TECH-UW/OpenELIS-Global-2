...
public abstract class AbstractHistoryService {
  ...
  protected abstract void getObservableChanges(
  ...
  protected void setAndAddIfValueNotNull(
      List<AuditTrailItem> items, History history, String attribute) {
  ...
  protected void simpleChange(
      Map<String, String> changeMap, String changesString, String attribute) {
