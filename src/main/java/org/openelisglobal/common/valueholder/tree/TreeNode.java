...
/**
 * This class represents each node in the tree. A TreeNode is the basic building
 * node in a Tree. Each TreeNode can exist only in one Tree at a time and cannot
 * be shared across different trees. <br>
 * For each TreeNode object, an equivalent JSTreeNode javascript object is
 * created on the client. The following javascript attributes will be available
 * for the treeNode on the client : <br>
 * <br>
...
public class TreeNode {
     ...
     *
     * @param name The name of the tree node. Note that the name should not contain
     *             the path delimeter.
     */
    public TreeNode(String name) {
        ...
        if (name.indexOf(pathDelimeter) != -1) {
            throw new IllegalArgumentException(
                    "The name of the TreeNode should not contain the path Delimeter - '" + pathDelimeter + "'");
        }
    ...
    /**
     * Method used by the addChild methods which construct a new tree node. It uses
     * reflection to create the subclass of TreeNode (if any) instead of a tree
     * node.
     *
    ...
    /**
     * @return Returns the tree associated with the node. This is set automatically
     *         by the framework when the tree is generated
     */
     ...
     *
     * @param name The name of the node. Note that the name should not contain the
     *             path delimeter character in it.
     * @return The newly added node. Note that if you have extended the TreeNode,
     *         the addChild method will return an instance of your subclass. So you
     *         can cast down to the subclass if desired.
     */
     ...
     * @param name   The name of the node. Note that the name should not contain the
     *               path delimeter character in it.
     * @param action The action associated with the node. This could be a url or a
     *               form name which should be submitted.
     * @param icon   The icon src which will be used to display the tree node. The
     *               same icon will be used to display expanded/collapsed tree.
     * @return The newly added node. Note that if you have extended the TreeNode,
     *         the addChild method will return an instance of your subclass. So you
     *         can cast down to the subclass if desired.
     */
    ...
    /**
     * Add a tree node as a child to the current node. This will create new child
     * node out of the current node and add it to the child list of the current
     * node.
     *
     * @param node The child node
     * @return The added child node. Note that if you have extended the TreeNode,
     *         the addChild method will return an instance of your subclass. So you
     *         can cast down to the subclass if desired.
     */
    ...
    private void copyNode(TreeNode original, TreeNode target) {
        ...
        if (original.popup != null) {
            target.popup = original.popup.clonePopup();
        }
    ...
    /**
     * Return the path associated with the node. This is essentially the path
     * separated by the node delimeter.
     *
    ...
    /**
     * @return Returns the displayed name of the TreeNode. This is an optional field
     *         and if it is not set, the tree will be displayed with the name
     */
    ...
    /**
     * Sets the displayed name of the TreeNode. If not set, the node will be
     * displayed with the original name
     *
    ...
    /**
     * This is an optional method on the TreeNode which sets the preSubmitAction. If
     * you want some javascript to be executed before the form associated with the
     * node is submitted, you can use the setPreSubmitAction method. Please ensure
     * that the javascript specified by this method does not submit a form, or else
     * the tree will be in an inconsistent state.
     *
     ...
     * This is an optional method on the TreeNode which sets the preSubmitAction. If
     * you want some javascript to be executed before the form associated with the
     * node is submitted when the node is clicked, you can use the
     * setPreSubmitScript method. Please ensure that the javascript specified by
     * this method does not submit a form, or else the tree will be in an
     * inconsistent state.
     *
     * Eg: node.setPreSubmitScript("javascript:askMeFirst(currentNode)");
     *
     * @param preSubmitScript The preSubmitScript to set. Please make sure that the
     *                        preSubmitScript returns a true or false. If the script
     *                        returns false, the node submit form / url will not be
     *                        submitted/executed.
     */
    ...
    /**
     * Sets the form to be submitted when this node is clicked. Each node can either
     * have a url or a form name associated with it. If you want to set a url, use
     * the setUrl method. If you want to set the form name, use setSubmitForm
     * method.
     *
     * @param submitForm The name of the form to be submitted. The form must exist
     *                   on the page, or else an error will be thrown
     */
    ...
    /**
     * @return Returns the target of the url, associated with the node. The
     *         urlTargetName can optionally be set when you set the url for the
     *         node.
     */
    ...
    /**
     * Sets the url associated with the node. Each node can either have a url or a
     * form name associated with it. If you want to set a url, use the setUrl
     * method. If you want to set the form name, use setSubmitForm method.
     *
     * @param url           The url to set.
     * @param urlTargetName If you want the url to open in a separate frame or a
     *                      window, please specify the name here. If not specified,
     *                      when the user clicks on the node, the url will replace
     *                      the window's contents.
     *
     *                      Typically this is used when you are displaying the tree
     *                      in a webpage with frames. You would want to specify the
     *                      frame name as this parameter where you want the contents
     *                      to be displayed.
     *
     */
    public void setUrl(String url, String urlTargetName) {
        // note that if the user creates a url, we still will submit a form, after
        // creating a new form
        // whose name is going to be the nodePath, separated by the underscore character
        // - "_".
        this.url = url;
    ...
    /**
     * @return Returns the icon source for the image shown when the node is closed.
     *         Should be a 16x16 pixel image
     */
    ...
    /**
     * Set the icon source for the image shown when the node is closed. Should be a
     * 16x16 pixel image
     *
    ...
    /**
     * @return Returns the icon source for the image shown when the node is
     *         expanded. Should be a 16x16 pixel image
     */
    ...
    /**
     * Returns the icon source for the image shown when the node is expanded. Should
     * be a 16x16 pixel image
     *
    ...
    /**
     * @return Returns the popup associated with the node, which is invoked when the
    ...
    /**
     * @return Returns the text which is displayed when the user hovers the mouse
     *         over the node image
     */
    ...
    /**
     * @param popupText Sets the text which is displayed when the user hovers the
     *                  mouse over the node image.
     */
    ...
    /**
     * @return Returns the data field of the tree node. Each tree node can have an
     *         string data field, which can have any arbitrary string data. This can
     *         be accessed in the javascript by using the node.data modifier.
     */
    ...
    /**
     * Set the data field of the tree node. Each TreeNode can optionally have an
     * abitrary data field if required. User can then access this field in the page
    ...
    /**
     * Sets up a node to support pagination for its children. By default a node does
     * not support pagination for the children. If pagination support is enabled,
     * the user is required to fill in the paginatedNodeChildCount variable also.
     * This is set using the setPaginatedNodeChildCount method.
     *
    ...
    /**
     * Returns the pageSize of the paginated node. The default page size of a
     * paginated node is 10.
     *
    ...
    /**
     * Set the page size of a paginated node. Default is 10, which means that if a
     * node has more than 10 children, the node will be displayed with the prev,next
     * links.
     *
    ...
    /**
     * Sets the number of children a paginated node has. This is required to be set
     * if a node is designated to be paginated.
     *
    ...
    /**
     * Sets the page range for the node. This indicates the tree node renderer what
     * is the current child range being displayed in the browser.
     *
    ...
    /**
     * Add an extra property on the tree node. This can then be accessed in the page
     * by using the node.<property name> method.
     *
     * @param name
     * @param value
     */
    ...
    /**
     * Get a named property for the node, which has been added by the addProperty
     * method.
     *
     * @param name
    ...
    /**
     * Convert some characters into html specific chars. '<' becomes &lt; '>'
    ...
    /**
     * Remove the unicode characters from the string and replace them with real
     * quotes
     *
     * @param source
     * @return String
     ...
     *
     * @param parent - This is the javascript representation of the parent node.
     *               Should be null for the root node
     * @return String
     */
    protected String getJavascriptDefinition(String parentVarName) {
        ...
        if (tree == null || tree.getName() == null) {
            throw new IllegalArgumentException(
                    "Each node should have a tree defined. Either the tree is null, or the name of tree is null.");
        }
        ...
        if (isPaginated()) {
            if (getPaginatedNodeChildCount() == 0) {
                throw new IllegalArgumentException(
                        "Please set the paginated node child count for the node. (using the setPaginatedNodeChildCount() method.)");
            }

            scriptBuffer.append("    " + getVarName() + ".isPaginated=true;\n");
            scriptBuffer
                    .append("    " + getVarName() + ".paginatedNodeChildCount=" + getPaginatedNodeChildCount() + ";\n");
            scriptBuffer.append("    " + getVarName() + ".pageSize=" + getPageSize() + ";\n");
            scriptBuffer.append("    " + getVarName() + ".pageRangeBegin="
                    + (getPageRangeBegin() == -1 ? "0" : String.valueOf(getPageRangeBegin())) + ";\n");
        }
        ...
        while (enumVar.hasMoreElements()) {
            ...
            scriptBuffer.append(
                    "    " + getVarName() + "." + element + "='" + escapeQuotes(props.getProperty(element)) + "';\n");
        }
    ...
    /**
     * The equals method is over-ridden for the TreeNode. If the passed in object is
     * a TreeNode, the equality test is based on the node path of the tree nodes.
     */
    @Override
    ...
    public String toString() {
        return "TreeNode: name=" + name + ", path=" + nodePath + ", submitFormName=" + submitFormName + ", data=" + data
