...
public class ResultsTreeProviderRestController {
  ...
  public List<ResultTree> getResultTreeArray(@RequestParam String patientId) {
    ...
    for (Result result : results) {
      ...
      panel =
          result.getAnalysis().getPanel() != null
              ? result.getAnalysis().getPanel()
      ...
      for (Panel panelEntry : entry.getValue()) {
        ...
        for (Map.Entry<Test, Set<Result>> testResultentry : testResultMap.entrySet()) {
          ...
          testDisplay.setDatatype(
              testResultentry.getValue().iterator().next().getTestResult() != null
          ...
          testDisplay.setUnits(
              testResultentry.getKey().getUnitOfMeasure() != null
        ...
        panelDisplay.setDisplay(
            panelEntry.getPanelName().contains("NEW") ? "" : panelEntry.getLocalizedName());
  ...
  @ResponseBody
  public PanelDisplay getTestResultTree(
      @RequestParam String patientId, @RequestParam String testId) {
