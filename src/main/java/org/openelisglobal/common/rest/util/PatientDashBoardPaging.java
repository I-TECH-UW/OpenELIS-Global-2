...
/**
 * Responsible for building a page by accepting all display and paging information. Based on the
 * page size and the page number, it will return the appropriate page.
 */
public class PatientDashBoardPaging {

  private final PagingUtility<List<OrderDisplayBean>> paging =
      new PagingUtility<>(); // Adjust type based on your data
  private static final PatientDashboardPageHelper pagingHelper =
      new PatientDashboardPageHelper(); // Implement helper class

  public void setDatabaseResults(
      HttpServletRequest request, PatientDashBoardForm form, List<OrderDisplayBean> orders)
  ...
  private static class PatientDashboardPageHelper
      implements IPageDivider<List<OrderDisplayBean>>,
          IPageUpdater<List<OrderDisplayBean>>,
          IPageFlattener<List<OrderDisplayBean>> {

    @Override
    public void createPages(
        List<OrderDisplayBean> orders, List<List<OrderDisplayBean>> pagedResults) {
