...
public class ResourceLocator {
  ...
  private ResourceLocator() throws RuntimeException {
    ...
    if (propertyStream == null) {
      ...
      throw new RuntimeException(
          "Resources Property file " + RESOURCE_PROPERTIES + " was not found.");
    }
  ...
  /**
   * Get passed in a resource name, and return an InputStream to the property file corresponding to
   * the resource name.
   *
  ...
  public String getResourceFileName(String pResourceName) throws RuntimeException {
    ...
    if (resourceFileName == null) {
      throw new RuntimeException(
          "Resource mapping for the file name " + pResourceName + " could not be found.");
    }
