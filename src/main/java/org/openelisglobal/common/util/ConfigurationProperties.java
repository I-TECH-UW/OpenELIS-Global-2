...
public abstract class ConfigurationProperties {
    ...
    public enum Property {
        ...
        StringContext("stringContext"), // Determines which equivalent string should be used. i.e. label for accession
        ...
        languageSwitch("allowLanguageChange"), // If true a user can switch between English and French (changes it for
                                               // everybody)
