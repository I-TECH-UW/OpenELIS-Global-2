...
public abstract class BaseObjectServiceImpl<T extends BaseObject<PK>, PK extends Serializable>
  ...
  public List<T> getAllMatching(String propertyName, Object propertyValue) {
    return getBaseObjectDAO()
        .getAllMatchingOrdered(propertyName, propertyValue, defaultSortOrder, false);
  }
  ...
  public List<T> getMatchingPage(String propertyName, Object propertyValue, int pageNumber) {
    return getBaseObjectDAO()
        .getMatchingOrderedPage(propertyName, propertyValue, defaultSortOrder, false, pageNumber);
  }
  ...
  public List<T> getMatchingPage(Map<String, Object> propertyValues, int pageNumber) {
    return getBaseObjectDAO()
        .getMatchingOrderedPage(propertyValues, defaultSortOrder, false, pageNumber);
  }
  ...
  public T save(T baseObject) {
    ...
    if ((baseObject.getId() instanceof String
            && GenericValidator.isBlankOrNull((String) baseObject.getId()))
  ...
  public T update(T baseObject) {
    if (baseObject.getLastupdated() == null) {
      ...
      LogEvent.logWarn(
          this.getClass().getSimpleName(),
          "update",
          "setting lastUpdated to now for object: "
  ...
  public void delete(T baseObject) {
    ...
    getBaseObjectDAO()
        .delete(
            getBaseObjectDAO()
                .get(baseObject.getId())
                .orElseThrow(
                    () -> new ObjectNotFoundException(baseObject.getId(), classType.getName())));
  }
