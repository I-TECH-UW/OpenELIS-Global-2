...
public abstract class AuditableBaseObjectServiceImpl<
        T extends BaseObject<PK>, PK extends Serializable>
    extends BaseObjectServiceImpl<T, PK> implements AuditableBaseObjectService {
  ...
  public PK insert(T baseObject) {
    ...
    if (auditTrailLog) {
      auditTrailService.saveNewHistory(
          baseObject, baseObject.getSysUserId(), getBaseObjectDAO().getTableName());
    }
    return id;
  }
  ...
  public void delete(T baseObject) {
    if (auditTrailLog) {
      auditTrailService.saveHistory(
          ...
          baseObject,
          baseObject.getSysUserId(),
          IActionConstants.AUDIT_TRAIL_DELETE,
          getBaseObjectDAO().getTableName());
    }
