 ...
 *     <p>This interface contains the constants for bean and attribute names used by the struts
 *     action classes.
 */
public interface IActionConstants {
  ...
  String RESULTS_ENTRY_ROUTING_FROM_BATCH_RESULTS_VERIFICATION_PARAM_TEST_ID =
      "resultsEntryFromBatchVerificationTestId";
  String RESULTS_ENTRY_ROUTING_FROM_BATCH_RESULTS_VERIFICATION_PARAM_ACCESSION_NUMBER =
      "resultsEntryFromBatchVerificationAccessionNumber";
  String RESULTS_ENTRY_ROUTING_FROM_BATCH_RESULTS_VERIFICATION_PARAM_TEST_SECTION_ID =
      "resultsEntryFromBatchVerificationTestSectionId";
  ...
  String QA_EVENTS_ENTRY_ROUTING_FROM_BATCH_RESULTS_ENTRY_PARAM_TEST_ID =
      "testIdForUnsatisfactorySamples";
  String QA_EVENTS_ENTRY_ROUTING_FROM_BATCH_RESULTS_ENTRY_PARAM_ACCESSION_NUMBERS =
      "accessionNumbersForUnsatisfactorySamples";
  ...
  String QAEVENTS_ENTRY_LINELISTING_PARAM_QAEVENT_CATEGORY_ID =
      "qaEventsEntryLineListingCategoryId";
  ...
  /**
   * The system_module name used to determine if the current user is allowed to edit primary patient
   * IDs (subject number & site subject number).
   */
