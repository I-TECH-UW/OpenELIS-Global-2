...
public class AuditTrailServiceImpl implements AuditTrailService {
  ...
  @Override
  public void saveNewHistory(BaseObject newObject, String sysUserId, String tableName)
    ...
    ReferenceTables referenceTable =
        referenceTablesService.getReferenceTableByName(referenceTables);
    ...
    if (referenceTable != null && !referenceTable.getKeepHistory().equals(IActionConstants.YES)) {
      LogEvent.logDebug(
          "AuditTrailDAOImpl", "saveNewHistory()", "NO CHANGES: REF TABLE KEEP_HISTORY IS N");
      return;
    }
    ...
    if (referenceTable == null) {
      ...
      throw new LIMSRuntimeException(
          "Reference Table is null in AuditTrailDAOImpl saveNewHistory()");
    }

    if ((sysUserId == null) || (sysUserId.length() == 0)) {
      LogEvent.logError("AuditTrailDAOImpl", "saveNewHistory()", "NO CHANGES: SYS_USER_ID IS NULL");
      throw new LIMSRuntimeException(
          "System User ID is null in AuditTrailDAOImpl saveNewHistory()");
    }
  ...
  public void saveHistory(
    ...
    if (rt != null && !rt.getKeepHistory().equals(IActionConstants.YES)) {
      // bugzilla 2154
      LogEvent.logDebug(
          "AuditTrailDAOImpl", "saveHistory()", "NO CHANGES: REF TABLE KEEP_HISTORY IS N");
      return;
    }
    if (rt == null) {
      // bugzilla 2154
    ...
    if ((newObject == null && IActionConstants.AUDIT_TRAIL_UPDATE.equals(event))
      ...
      // bugzilla 1926
      throw new LIMSRuntimeException(
          "New object, existing object, table name or event is null in AuditTrailDAOImpl"
              + " saveHistory()");
    }
    ...
    for (int ii = 0; ii < fields.length; ii++) {
      ...
      if ((!fieldName.equals("id"))
        ...
        if (fieldName.equals("qaEvent") || fieldName.equals("sample")) {
          LabelValuePair lvb =
              processLabelValueFixes(fieldName, propertyPreUpdateState, existingObject, newObject);
          if (lvb != null) {
          ...
          if (propertyNewState.equals(propertyPreUpdateState)) {
            ...
            LabelValuePair lvb =
                processLabelValue(fieldName, propertyPreUpdateState, existingObject, newObject);
            if (lvb != null) {
   ...
   * @return a label value object bugzilla 2134 fixed the analysis_qaevent completed date problem
   *     bugzilla 2122 fixed the sample collection_date problem
   */
  private LabelValuePair processLabelValueFixes(
      String fieldName, String propertyPreUpdateState, Object existingObject, Object newObject) {
   ...
   */
  private LabelValuePair processLabelValue(
      String fieldName, String propertyPreUpdateState, Object existingObject, Object newObject) {
    ...
    if (propertyPreUpdateState.startsWith("{org.openelisglobal")) {
      if (fieldName.equals("test")) {
        ...
        // testreflex
        try {
          org.openelisglobal.testreflex.valueholder.TestReflex data =
              (org.openelisglobal.testreflex.valueholder.TestReflex) existingObject;

          org.openelisglobal.testreflex.valueholder.TestReflex data2 =
              (org.openelisglobal.testreflex.valueholder.TestReflex) newObject;
