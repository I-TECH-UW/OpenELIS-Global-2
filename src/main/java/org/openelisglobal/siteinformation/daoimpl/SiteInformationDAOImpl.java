...
@Component
@Transactional
public class SiteInformationDAOImpl extends BaseDAOImpl<SiteInformation, String>
  ...
  public void getData(SiteInformation siteInformation) throws LIMSRuntimeException {
    try {
      SiteInformation tmpSiteInformation =
          entityManager.unwrap(Session.class).get(SiteInformation.class, siteInformation.getId());
  ...
  public List<SiteInformation> getAllSiteInformation() throws LIMSRuntimeException {
    ...
    try {
      ...
      Query<SiteInformation> query =
          entityManager.unwrap(Session.class).createQuery(sql, SiteInformation.class);
      list = query.list();
  ...
  public SiteInformation readSiteInformation(String idString) {
    ...
    try {
      recoveredSiteInformation =
          entityManager.unwrap(Session.class).get(SiteInformation.class, idString);
    } catch (RuntimeException e) {
      LogEvent.logError(e);
