...
@Service
public class SiteInformationServiceImpl
    extends AuditableBaseObjectServiceImpl<SiteInformation, String>
  ...
  @Autowired private ConfigurationSideEffects configurationSideEffects;
  ...
  public List<SiteInformation> getPageOfSiteInformationByDomainName(
      int startingRecNo, String dbDomainName) {
  ...
  public List<SiteInformation> getSiteInformationByDomainName(String domainName) {
    List<SiteInformation> siteInformations =
        getBaseObjectDAO().getSiteInformationByDomainName(domainName);
  ...
  @Override
  @Transactional(readOnly = true)
  public List<SiteInformation> getAllMatchingOrdered(
      String propertyName, Object propertyValue, String orderProperty, boolean descending) {
    List<SiteInformation> siteInformations =
        super.getAllMatchingOrdered(propertyName, propertyValue, orderProperty, descending);
    for (SiteInformation siteInformation : siteInformations) {
      decryptSiteInformation(siteInformation);
    }
    return siteInformations;
  ...
  public List<SiteInformation> getAllMatchingOrdered(
    ...
    List<SiteInformation> siteInformations =
        super.getAllMatchingOrdered(propertyName, propertyValue, orderProperties, descending);
    for (SiteInformation siteInformation : siteInformations) {
      decryptSiteInformation(siteInformation);
    }
    return siteInformations;
  ...
  public List<SiteInformation> getAllMatchingOrdered(
    ...
    List<SiteInformation> siteInformations =
        super.getAllMatchingOrdered(propertyValues, orderProperty, descending);
    for (SiteInformation siteInformation : siteInformations) {
      decryptSiteInformation(siteInformation);
    }
    return siteInformations;
  ...
  public List<SiteInformation> getAllMatchingOrdered(
    ...
    List<SiteInformation> siteInformations =
        super.getAllMatchingOrdered(propertyValues, orderProperties, descending);
    for (SiteInformation siteInformation : siteInformations) {
      decryptSiteInformation(siteInformation);
    }
    return siteInformations;
  ...
  @Override
  @Transactional(readOnly = true)
  public List<SiteInformation> getMatchingPage(
      String propertyName, Object propertyValue, int startingRecNo) {
    List<SiteInformation> siteInformations =
        super.getMatchingPage(propertyName, propertyValue, startingRecNo);
    for (SiteInformation siteInformation : siteInformations) {
      decryptSiteInformation(siteInformation);
    }
    return siteInformations;
  ...
  @Transactional(readOnly = true)
  public List<SiteInformation> getMatchingPage(
      Map<String, Object> propertyValues, int startingRecNo) {
  ...
  @Override
  @Transactional(readOnly = true)
  public List<SiteInformation> getOrderedPage(
      String orderProperty, boolean descending, int startingRecNo) {
    List<SiteInformation> siteInformations =
        super.getOrderedPage(orderProperty, descending, startingRecNo);
    for (SiteInformation siteInformation : siteInformations) {
      decryptSiteInformation(siteInformation);
    }
    return siteInformations;
  ...
  public List<SiteInformation> getOrderedPage(
    ...
    List<SiteInformation> siteInformations =
        super.getOrderedPage(orderProperties, descending, startingRecNo);
    for (SiteInformation siteInformation : siteInformations) {
      decryptSiteInformation(siteInformation);
    }
    return siteInformations;
  ...
  @Override
  @Transactional(readOnly = true)
  public List<SiteInformation> getMatchingOrderedPage(
      String propertyName,
      ...
      int startingRecNo) {
    List<SiteInformation> siteInformations =
        super.getMatchingOrderedPage(
            propertyName, propertyValue, orderProperty, descending, startingRecNo);
    for (SiteInformation siteInformation : siteInformations) {
      decryptSiteInformation(siteInformation);
    }
    return siteInformations;
  ...
  public List<SiteInformation> getMatchingOrderedPage(
    ...
    List<SiteInformation> siteInformations =
        super.getMatchingOrderedPage(
            propertyName, propertyValue, orderProperties, descending, startingRecNo);
    for (SiteInformation siteInformation : siteInformations) {
      decryptSiteInformation(siteInformation);
    }
    return siteInformations;
  ...
  public List<SiteInformation> getMatchingOrderedPage(
      ...
      int startingRecNo) {
    List<SiteInformation> siteInformations =
        super.getMatchingOrderedPage(propertyValues, orderProperty, descending, startingRecNo);
    for (SiteInformation siteInformation : siteInformations) {
      decryptSiteInformation(siteInformation);
    }
    return siteInformations;
  ...
  public List<SiteInformation> getMatchingOrderedPage(
      ...
      int startingRecNo) {
    List<SiteInformation> siteInformations =
        super.getMatchingOrderedPage(propertyValues, orderProperties, descending, startingRecNo);
    for (SiteInformation siteInformation : siteInformations) {
      decryptSiteInformation(siteInformation);
    }
    return siteInformations;
  ...
  public SiteInformation save(SiteInformation siteInformation) {
    if ((siteInformation.getId() instanceof String
            && GenericValidator.isBlankOrNull(siteInformation.getId()))
