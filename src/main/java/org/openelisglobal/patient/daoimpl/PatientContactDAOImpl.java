...
@Component
@Transactional
public class PatientContactDAOImpl extends BaseDAOImpl<PatientContact, String>
    implements PatientContactDAO {
  ...
  public List<PatientContact> getForPatient(String patientId) {
    ...
    try {
      ...
      Query<PatientContact> query =
          entityManager.unwrap(Session.class).createQuery(sql, PatientContact.class);
