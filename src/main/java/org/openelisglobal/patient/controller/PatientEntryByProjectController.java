...
public class PatientEntryByProjectController extends BasePatientEntryByProject {
  ...
  @Autowired private PatientEntryByProjectFormValidator formValidator;
  ...
  public ModelAndView showPatientEntryByProjectUpdate(
      HttpServletRequest request,
      @ModelAttribute("form") @Valid PatientEntryByProjectForm form,
    ...
    addAllPatientFormLists(form);
    IPatientEditUpdate patientEditUpdateAccessioner =
        SpringContext.getBean(IPatientEditUpdate.class);
    ...
    IPatientSecondEntry patientSecondEntryAccessioner =
        SpringContext.getBean(IPatientSecondEntry.class);
    ...
    IPatientEntryAfterSampleEntry patientEntryAfterSampleEntryAccessioner =
        SpringContext.getBean(IPatientEntryAfterSampleEntry.class);
    ...
    IPatientEntryAfterAnalyzer patientEntryAfterAnalyzerAccessioner =
        SpringContext.getBean(IPatientEntryAfterAnalyzer.class);
  ...
  protected String findLocalForward(String forward) {
    if (FWD_SUCCESS.equals(forward)) {
      ...
      String redirectURL =
          "/PatientEntryByProject?type=" + Encode.forUriComponent(request.getParameter("type"));
