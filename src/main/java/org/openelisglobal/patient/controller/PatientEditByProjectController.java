...
public class PatientEditByProjectController extends BasePatientEntryByProject {
  ...
  @Autowired private PatientEditByProjectFormValidator formValidator;
  ...
  public ModelAndView showPatientEditByProjectSave(
      HttpServletRequest request,
      @ModelAttribute("form") @Valid PatientEditByProjectForm form,
