...
public class PatientManagementInfo implements Serializable {
  ...
  @OptionalNotBlank(
      properties = {Property.PATIENT_SUBJECT_NUMBER_REQUIRED},
      groups = {SamplePatientEntryForm.SamplePatientEntry.class})
  @Pattern(
      regexp = ValidationHelper.PATIENT_ID_REGEX,
      groups = {SamplePatientEntryForm.SamplePatientEntry.class, SamplePatientEntryBatch.class})
  ...
  @OptionalNotBlank(
      properties = {Property.PATIENT_NATIONAL_ID_REQUIRED},
      groups = {SamplePatientEntryForm.SamplePatientEntry.class})
  @Pattern(
      regexp = ValidationHelper.PATIENT_ID_REGEX,
      groups = {SamplePatientEntryForm.SamplePatientEntry.class, SamplePatientEntryBatch.class})
  ...
  @OptionalNotBlank(
      formFields = {Field.PatientNameRequired},
      groups = {SamplePatientEntryForm.SamplePatientEntry.class})
  @ValidName(
  ...
  @Pattern(
      regexp = ValidationHelper.GENDER_REGEX,
      groups = {SamplePatientEntryForm.SamplePatientEntry.class, SamplePatientEntryBatch.class})
  ...
  @Valid private PatientContact patientContact;
  ...
  public List<IdValuePair> getHealthDistricts() {
    ...
    if (!GenericValidator.isBlankOrNull(healthRegion)) {
      List<Organization> districts =
          SpringContext.getBean(OrganizationService.class).getOrganizationsByParentId(healthRegion);
