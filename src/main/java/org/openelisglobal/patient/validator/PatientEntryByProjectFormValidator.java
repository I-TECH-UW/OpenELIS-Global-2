...
public class PatientEntryByProjectFormValidator implements Validator {
  ...
  private void validateEIDForm(PatientEntryByProjectForm form, Errors errors) {
    ValidationHelper.validateFieldRequired(
        form.getReceivedDateForDisplay(), "receivedDateForDisplay", errors);

    ValidationHelper.validateFieldRequired(form.getInterviewDate(), "interviewDate", errors);

    ValidationHelper.validateFieldRequired(
        form.getProjectData().getEIDSiteName(), "ProjectData.EIDSiteName", errors);

    ValidationHelper.validateFieldRequired(
        form.getProjectData().getEIDsiteCode(), "ProjectData.EIDSiteCode", errors);
    ...
    ValidationHelper.validateFieldRequired(
        form.getBirthDateForDisplay(), "birthDateForDisplay", errors);
  }
  ...
  private void validateRTNForm(PatientEntryByProjectForm form, Errors errors) {
    ...
    ValidationHelper.validateFieldRequired(
        form.getObservations().getNameOfDoctor(), "observations.nameOfDoctor", errors);
    ...
    ValidationHelper.validateFieldRequired(
        form.getObservations().getService(), "observations.service", errors);
