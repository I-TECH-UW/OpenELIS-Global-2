...
public interface AnalysisDAO extends BaseDAO<Analysis, String> {
  ...
  List<Analysis> getAllAnalysisByTestSectionAndStatus(
      String testSectionId, List<Integer> statusIdList, boolean sortedByDateAndAccession)
      throws LIMSRuntimeException;

  List<Analysis> getAllAnalysisByTestSectionAndExcludedStatus(
  ...
  List<Analysis> getAnalysesBySampleItemsExcludingByStatusIds(
  ...
  List<Analysis> getAnalysesBySampleStatusIdExcludingByStatusId(
  ...
  List<Analysis> getRevisionHistoryOfAnalysesBySampleAndTest(
  ...
  List<Analysis> getAnalysisCollectedOnExcludedByStatusId(
  ...
  List<Analysis> getAnalysisByTestIdAndTestSectionIdsAndStartedInDateRange(
  ...
  List<Analysis> getAnalysisByTestNamesAndCompletedDateRange(
  ...
  List<Analysis> getAnalysisByTestDescriptionAndCompletedDateRange(
      List<String> descriptions, Date sqlDayOne, Date sqlDayTwo) throws LIMSRuntimeException;

  Analysis getAnalysisById(String analysisId) throws LIMSRuntimeException;

  List<Analysis> getAllAnalysisByTestsAndStatus(
      List<Integer> testIds, List<Integer> analysisStatusList, List<Integer> sampleStatusList);

  @Override
  List<Analysis> get(List<String> value);

  List<Analysis> getAllAnalysisByTestsAndStatusAndCompletedDateRange(
  ...
  List<Analysis> getAllAnalysisByTestsAndStatusAndCompletedDateRange(
      List<String> nfsTestIdList, List<Integer> statusList, Date lowDate, Date highDate);

  List<Analysis> getPageAnalysisByTestSectionAndStatus(
      String testSectionId, List<Integer> analysisStatusList, List<Integer> sampleStatusList);
  ...
  List<Analysis> getPageAnalysisAtAccessionNumberAndStatus(
  ...
  List<Analysis> getPageAnalysisByStatusFromAccession(
      List<Integer> analysisStatusList, List<Integer> sampleStatusList, String accessionNumber);
  ...
  List<Analysis> getAnalysisForSiteBetweenResultDates(
      String referringSiteId, LocalDate lowerDate, LocalDate upperDate);

  List<Analysis> getAnalysesByPriorityAndStatusId(
      OrderPriority priority, List<Integer> analysisStatusIds);

  List<Analysis> getStudyAnalysisForSiteBetweenResultDates(
      String referringSiteId, LocalDate lowerDate, LocalDate upperDate);

  List<Analysis> getAnalysesCompletedOnByStatusId(Date completedDate, String statusId)
      throws LIMSRuntimeException;

  List<Analysis> getAnalysesResultEnteredOnExcludedByStatusId(
