...
public class AnalysisDAOImpl extends BaseDAOImpl<Analysis, String> implements AnalysisDAO {
  ...
  public void getData(Analysis analysis) throws LIMSRuntimeException {
    ...
    try {
      Analysis analysisClone =
          entityManager.unwrap(Session.class).get(Analysis.class, analysis.getId());
  ...
  public List<Analysis> getAllAnalysisByTestAndStatus(String testId, List<Integer> statusIdList)
    ...
    try {
      String sql =
          "from Analysis a where a.test = :testId and a.statusId IN (:statusIdList) order by"
  ...
  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getAllAnalysisByTestsAndStatus(
      List<String> testIdList, List<Integer> statusIdList) throws LIMSRuntimeException {
    List<Integer> testList = new ArrayList<>();
    try {
      String sql =
          "from Analysis a where a.test.id IN (:testList) and a.statusId IN (:statusIdList) order"
  ...
  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getAllAnalysisByTestsAndStatusAndCompletedDateRange(
      List<String> testIdList, List<Integer> statusIdList, Date lowDate, Date highDate)
      throws LIMSRuntimeException {
    List<Integer> testList = new ArrayList<>();
    try {
      String sql =
          "from Analysis a where a.test.id IN (:testList) and a.statusId IN (:statusIdList) and"
      ...
      throw new LIMSRuntimeException(
          "Error in Analysis getAllAnalysisByTestsAndStatusAndCompletedDateRange()", e);
    }
  }

  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getAllAnalysisByTestAndExcludedStatus(
      String testId, List<Integer> statusIdList) throws LIMSRuntimeException {
    try {
      String sql =
          "from Analysis a where a.test = :testId and a.statusId not IN (:statusIdList) order by"
              + " a.sampleItem.sample.accessionNumber";
      ...
      LogEvent.logError(e);
      throw new LIMSRuntimeException(
          "Error in Analysis getAllAnalysisByTestAndExcludedStatuses()", e);
    }
  }
  ...
  public List<Analysis> getAllAnalysisByTestSectionAndStatus(
      String testSectionId, List<Integer> statusIdList, boolean sortedByDateAndAccession)
      throws LIMSRuntimeException {
    ...
    try {
      ...
      LogEvent.logError(e);
      throw new LIMSRuntimeException(
          "Error in Analysis getAllAnalysisByTestSectionAndStatuses()", e);
    }
  }

  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getPageAnalysisByTestSectionAndStatus(
      String testSectionId, List<Integer> statusIdList, boolean sortedByDateAndAccession)
      throws LIMSRuntimeException {
    try {
      String sql =
  ...
  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getPageAnalysisAtAccessionNumberAndStatus(
      String accessionNumber, List<Integer> statusIdList, boolean sortedByDateAndAccession)
      throws LIMSRuntimeException {
    ...
    try {
      ...
      LogEvent.logError(e);
      throw new LIMSRuntimeException(
          "Error in Analysis getPageAnalysisAtAccessionNumberAndStatus()", e);
    }
  }

  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getAllAnalysisByTestSectionAndExcludedStatus(
      String testSectionId, List<Integer> statusIdList) throws LIMSRuntimeException {
    try {
      String sql =
          "from Analysis a where a.testSection.id = :testSectionId and a.statusId NOT IN"
      ...
      LogEvent.logError(e);
      throw new LIMSRuntimeException(
          "Error in Analysis getAllAnalysisByTestSectionAndExcludedStatuses()", e);
    }
  }
  ...
  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getAnalysesBySampleItemsExcludingByStatusIds(
      SampleItem sampleItem, Set<Integer> statusIds) throws LIMSRuntimeException {
    ...
    try {
      String sql =
          "from Analysis a where a.sampleItem.id = :sampleItemId and a.statusId not in ("
              + " :statusList )";
      ...
      LogEvent.logError(e);
      throw new LIMSRuntimeException(
          "Error in Analysis getAnalysesBySampleItemsExcludingByStatusIds()", e);
    }
  ...
  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getAnalysesBySampleStatusIdExcludingByStatusId(
      String statusId, Set<Integer> statusIds) throws LIMSRuntimeException {
    if (statusIds == null || statusIds.isEmpty()) {
      return getAnalysesBySampleStatusId(statusId);
    }

    String sql =
        "from Analysis a where a.sampleItem.sample.statusId = :sampleStatus and a.statusId not in"
            + " (:excludedStatusIds)";
  ...
  public List<Analysis> getAnalysesBySampleIdExcludedByStatusId(String id, Set<Integer> statusIds)
    ...
    String sql =
        "from Analysis a where a.sampleItem.sample.id = :sampleId and a.statusId not in ("
            + " :excludedIds)";
  ...
  public List<Analysis> getAnalysesBySampleIdAndStatusId(String id, Set<Integer> statusIds)
    ...
    String sql =
        "from Analysis a where a.sampleItem.sample.id = :sampleId and a.statusId in ( :statusIds)";
  ...
  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getAnalysesByPriorityAndStatusId(
      OrderPriority priority, List<Integer> statusIds) throws LIMSRuntimeException {
    String sql =
        "from Analysis a where a.sampleItem.sample.priority = :oderpriority and a.statusId in ("
            + " :statusIds)";
  ...
  /**
   * bugzilla 1993 (part of 1942) getAnalysesReadyToBeReported() - returns the tests that should be
   * updated with a printed date of today's date (see ResultsReport)
   */
  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getAnalysesReadyToBeReported() throws LIMSRuntimeException {
    try {
      ...
      return entityManager
          ...
          .createQuery(sql, Analysis.class)
  ...
  public List<Analysis> getMaxRevisionAnalysesBySample(SampleItem sampleItem)
    ...
    try {
      String sql =
          "from Analysis a where (a.sampleItem.id, a.test.id, a.revision) IN "
  ...
  public List<Analysis> getRevisionHistoryOfAnalysesBySample(SampleItem sampleItem)
    ...
    try {
      String sql =
          "from Analysis a where (a.sampleItem.id, a.test.id, a.revision) NOT IN "
              + "(select b.sampleItem.id, b.test.id, max(b.revision) from Analysis b "
              + "group by b.sampleItem.id, b.test.id) "
              + "and a.sampleItem.id = :param "
              + "and a.status NOT IN (:param2) "
  ...
  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getRevisionHistoryOfAnalysesBySampleAndTest(
    ...
    try {
      ...
      if (includeLatestRevision) {
        sql =
            "from Analysis a "
                + "where a.sampleItem.id = :param "
                + "and a.status NOT IN (:param3) "
                + "and a.test.id = :param2 "
                + "order by a.test.id, a.revision desc";
      } else {
        sql =
            "from Analysis a where (a.sampleItem.id, a.test.id, a.revision) NOT IN "
  ...
  public List<Analysis> getAllMaxRevisionAnalysesPerTest(Test test) throws LIMSRuntimeException {
    try {
      String sql =
          "from Analysis a where (a.sampleItem.id, a.revision) IN "
              + "(select b.sampleItem.id, max(b.revision) from Analysis b "
              + "group by b.sampleItem.id) "
              + "and a.test = :param "
              + "and a.status NOT IN (:param2) "
              + "order by a.sampleItem.sample.accessionNumber";
  ...
  public List<Analysis> getMaxRevisionAnalysesReadyToBeReported() throws LIMSRuntimeException {
    try {
      ...
      return entityManager
          .unwrap(Session.class)
          .createNativeQuery(sql, Analysis.class)
          .setParameterList("analysisStatusesToInclude", analysisStatusesToInclude)
          .setParameterList("sampleStatusesToInclude", sampleStatusesToInclude)
          .list();
      ...
      LogEvent.logError(e);
      throw new LIMSRuntimeException(
          "Error in Analysis getMaxRevisionAnalysesReadyToBeReported()", e);
    }
  }
  ...
  @Override
  @Transactional
  public List<Analysis> getMaxRevisionAnalysesReadyForReportPreviewBySample(
      List<String> accessionNumbers) throws LIMSRuntimeException {
    ...
    try {
      ...
      if (accessionNumbers != null && accessionNumbers.size() > 0) {
        String sql =
            "select distinct anal.id\n"
                ...
                + "            --bugzilla 2509 removed exclusion of holdable not completed qa"
                + " events\n"
                + "            --bugzilla 2028 make sure we exclude the samples for which tests qa"
                + " events are not completed\n"
                + "            --isQaEventsCompleted is 'Y' or 'N'\n"
        ...
        list =
            entityManager
                ...
                .setParameterList("analysisStatusesToInclude", analysisStatusesToInclude)
                .setParameterList("sampleStatusesToInclude", sampleStatusesToInclude)
                .setParameterList("samplesToInclude", accessionNumbers)
                .list();
      }
      ...
      LogEvent.logError(e);
      throw new LIMSRuntimeException(
          "Error in getMaxRevisionAnalysesReadyForReportPreviewBySample()", e);
    }
    return list;
  }
  ...
  public List<Analysis> getMaxRevisionPendingAnalysesReadyToBeReportedBySample(Sample sample)
    ...
    try {
      ...
      LogEvent.logError(e);
      throw new LIMSRuntimeException(
          "Error in Analysis getMaxRevisionPendingAnalysesReadyToBeReportedBySample()", e);
    }
  }
  ...
  public List<Analysis> getMaxRevisionPendingAnalysesReadyForReportPreviewBySample(Sample sample)
    ...
    try {
      ...
      LogEvent.logError(e);
      throw new LIMSRuntimeException(
          "Error in getMaxRevisionPendingAnalysesReadyForReportPreviewBySample()", e);
    }
  ...
  public Analysis getPreviousAnalysisForAmendedAnalysis(Analysis analysis)
    ...
    try {
      ...
      String sql =
          "from Analysis a where a.revision = :param and a.sampleItem = :param2 and a.test ="
      ...
      LogEvent.logError(e);
      throw new LIMSRuntimeException(
          "Exception occurred in getPreviousAnalysisForAmendedAnalysis", e);
    }
  ...
  public void getMaxRevisionAnalysisBySampleAndTest(Analysis analysis) throws LIMSRuntimeException {
    ...
    try {
      ...
      LogEvent.logError(e);
      throw new LIMSRuntimeException(
          "Error in Analysis getMaxRevisionAnalysisBySampleAndTest()", e);
    }
  }
  ...
  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getAnalysisStartedOnExcludedByStatusId(
      Date collectionDate, Set<Integer> statusIds) throws LIMSRuntimeException {
    if (statusIds == null || statusIds.isEmpty()) {
      return getAnalysisStartedOn(collectionDate);
    }

    String sql =
        "from Analysis a where a.startedDate = :startedDate and a.statusId not in ( :statusList )";
  ...
  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getAnalysisCollectedOnExcludedByStatusId(
      Date collectionDate, Set<Integer> statusIds) throws LIMSRuntimeException {
    if (statusIds == null || statusIds.isEmpty()) {
      return getAnalysisStartedOn(collectionDate);
    }
    ...
    String sql =
        "from Analysis a where DATE(a.sampleItem.collectionDate) = DATE(:startedDate) and"
  ...
  /**
   * @see
   *     org.openelisglobal.analysis.dao.AnalysisDAO#getAnalysisBySampleAndTestIds(java.lang.String,
   *     java.util.List)
   */
  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getAnalysisBySampleAndTestIds(String sampleId, List<Integer> testIds) {
    ...
    try {
      ...
      String sql =
          "from Analysis a WHERE a.sampleItem.sample.id = :sampleId AND a.test.id IN ( :testIds )";
      Query<Analysis> query = entityManager.unwrap(Session.class).createQuery(sql, Analysis.class);
  ...
  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getAnalysisByTestSectionAndCompletedDateRange(
      String sectionID, Date lowDate, Date highDate) throws LIMSRuntimeException {

    String sql =
        "From Analysis a where a.testSection.id = :testSectionId and a.completedDate BETWEEN"
  ...
  public List<Analysis> getAnalysisStartedOrCompletedInDateRange(Date lowDate, Date highDate)
      throws LIMSRuntimeException {
    String sql =
        "From Analysis a where a.startedDate BETWEEN :lowDate AND :highDate or a.completedDate"
  ...
  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getAnalysisByTestIdAndTestSectionIdsAndStartedInDateRange(
      Date lowDate, Date highDate, String testId, List<Integer> testSectionIds)
      throws LIMSRuntimeException {
    String sql =
        "FROM Analysis a WHERE a.startedDate BETWEEN :lowDate AND :highDate AND a.test.id = :testId"
    ...
    if (!GenericValidator.isBlankOrNull(id)) {
      try {
        ...
        Query<Analysis> query =
            entityManager.unwrap(Session.class).createQuery(sql, Analysis.class);
        query.setParameter("sampleId", Integer.parseInt(id));
  ...
  @Transactional(readOnly = true)
  public List<Analysis> getAllAnalysisByTestsAndStatus(
      List<Integer> testIds, List<Integer> analysisStatusList, List<Integer> sampleStatusList) {
    String sql =
        "From Analysis a WHERE a.test.id IN (:testIds) AND a.statusId IN (:analysisStatusList) AND"
  ...
  @Transactional(readOnly = true)
  public List<Analysis> getAllAnalysisByTestsAndStatusAndCompletedDateRange(
      List<Integer> testIdList,
      List<Integer> analysisStatusList,
    ...
    try {
      String sql =
          "from Analysis a where a.test.id IN (:testList) and a.statusId IN (:analysisStatusList)"
  ...
  @Transactional(readOnly = true)
  public List<Analysis> getAllAnalysisByTestSectionAndStatus(
      String testSectionId, List<Integer> analysisStatusList, List<Integer> sampleStatusList)
      throws LIMSRuntimeException {
  ...
  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getAnalysisStartedOnRangeByStatusId(
      Date lowDate, Date highDate, String statusID) throws LIMSRuntimeException {
    String sql =
        "From Analysis a where a.statusId = :statusID and a.startedDate BETWEEN :lowDate AND"
            + " :highDate";
  ...
  public List<Analysis> getAnalysisCompleteInRange(Timestamp lowDate, Timestamp highDate)
      throws LIMSRuntimeException {
    String sql =
        "From Analysis a where a.completedDate >= :lowDate AND a.completedDate < :highDate";
  ...
  public List<Analysis> getAnalysisByAccessionAndTestId(String accessionNumber, String testId)
    ...
    String sql =
        "From Analysis a where a.sampleItem.sample.accessionNumber = :accessionNumber and a.test.id"
            + " = :testId";
  ...
  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getAnalysisByTestNamesAndCompletedDateRange(
      List<String> testNames, Date lowDate, Date highDate) throws LIMSRuntimeException {
    if (testNames.isEmpty()) {
      return new ArrayList<>();
    }

    String sql =
        "From Analysis a where (a.test.localizedTestName.english in (:testNames) or"
  ...
  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getAnalysisByTestDescriptionAndCompletedDateRange(
      List<String> descriptions, Date lowDate, Date highDate) throws LIMSRuntimeException {
    if (descriptions.isEmpty()) {
      return new ArrayList<>();
    }

    String sql =
        "From Analysis a where a.test.description in (:descriptions) and a.completedDate BETWEEN"
            + " :lowDate AND :highDate";
  ...
  public List<Analysis> getAnalysesBySampleItemIdAndStatusId(String sampleItemId, String statusId)
    ...
    try {
      String sql =
          "from Analysis a where a.sampleItem.id = :sampleItemId and a.statusId = :statusId";
  ...
  @Override
  @Transactional(readOnly = true)
  public List<Analysis> getAnalysesBySampleIdTestIdAndStatusId(
      List<Integer> sampleIdList, List<Integer> testIdList, List<Integer> statusIdList)
      throws LIMSRuntimeException {
    ...
    String sql =
        "from Analysis a where a.sampleItem.sample.id in (:sampleIdList) and a.test.id in"
  ...
  public List<Analysis> get(List<String> ids) {
    ...
    try {
      ...
      query.setParameterList(
          "ids", ids.stream().map(e -> Integer.parseInt(e)).collect(Collectors.toList()));
      List<Analysis> analysisList = query.list();
      return analysisList;
    } catch (HibernateException e) {
  ...
  @Override
  public int getCountAnalysisByTestSectionAndStatus(
      String testSectionId, List<Integer> analysisStatusList, List<Integer> sampleStatusList) {

    String hql =
        "SELECT COUNT(*) From Analysis a WHERE a.testSection.id = :testSectionId AND a.statusId IN"
  ...
  @Override
  public int getCountAnalysisByTestSectionAndStatus(
      String testSectionId, List<Integer> analysisStatusList) {
  ...
  @Override
  public List<Analysis> getPageAnalysisByStatusFromAccession(
      List<Integer> analysisStatusList, List<Integer> sampleStatusList, String accessionNumber) {

    String sql =
        "From Analysis a WHERE a.sampleItem.sample.accessionNumber >= :accessionNumber" //
            + " AND length(a.sampleItem.sample.accessionNumber) = length(:accessionNumber)" //
  ...
  public List<Analysis> getPageAnalysisByStatusFromAccession(
      ...
      String upperRangeAccessionNumber,
      boolean doRange,
      boolean finished) {
    ...
    if (finished) {
      ...
      analysisStatusList.add(
          Integer.parseInt(
              SpringContext.getBean(IStatusService.class)
                  .getStatusID(AnalysisStatus.SampleRejected)));
      analysisStatusList.add(
          Integer.parseInt(
              SpringContext.getBean(IStatusService.class)
    ...
    if (doRange && StringUtils.isNotBlank(upperRangeAccessionNumber))
      sql =
          "From Analysis a WHERE a.sampleItem.sample.accessionNumber between :accessionNumber and"
  ...
  @Override
  public int getCountAnalysisByStatusFromAccession(
      List<Integer> analysisStatusList, List<Integer> sampleStatusList, String accessionNumber) {

    String hql =
        "SELECT COUNT(*) From Analysis a WHERE "
            + " a.statusId IN (:analysisStatusList)"
            + " AND a.sampleItem.sample.statusId IN (:sampleStatusList)";
    try {
      Query<Long> query = entityManager.unwrap(Session.class).createQuery(hql, Long.class);
      query.setParameterList("analysisStatusList", analysisStatusList);
  ...
  @Override
  public List<Analysis> getAnalysisForSiteBetweenResultDates(
      String referringSiteId, LocalDate lowerDate, LocalDate upperDate) {
    String hql =
        "FROM Analysis a WHERE a.enteredDate BETWEEN :lowerDate AND :upperDate AND"
  ...
  @Override
  public List<Analysis> getStudyAnalysisForSiteBetweenResultDates(
      String referringSiteId, LocalDate lowerDate, LocalDate upperDate) {
    String hql =
        "FROM Analysis a WHERE a.releasedDate BETWEEN :lowerDate AND :upperDate AND"
  ...
  public int getCountOfAnalysisCompletedOnByStatusId(Date completedDate, List<Integer> statusIds) {
    String sql =
        "SELECT COUNT(*) From Analysis a where a.releasedDate = :releasedDate and a.statusId in ("
            + " :statusList )";
  ...
  @Override
  public int getCountOfAnalysisStartedOnExcludedByStatusId(
      Date collectionDate, Set<Integer> statusIds) {

    String sql =
        "SELECT COUNT(*) from Analysis a where a.startedDate = :startedDate and a.statusId not in ("
            + " :statusList )";
  ...
  public int getCountOfAnalysisStartedOnByStatusId(Date startedDate, List<Integer> statusIds) {
    String sql =
        "SELECT COUNT(*) from Analysis a where a.startedDate = :startedDate and a.statusId in ("
            + " :statusList )";
  ...
  @Override
  public List<Analysis> getAnalysesResultEnteredOnExcludedByStatusId(
      Date completedDate, Set<Integer> statusIds) throws LIMSRuntimeException {
    String sql =
        "from Analysis a where a.completedDate = :completedDate and a.statusId not in ( :statusList"
            + " )";
