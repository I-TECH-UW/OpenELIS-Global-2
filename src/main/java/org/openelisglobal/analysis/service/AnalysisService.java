...
public interface AnalysisService extends BaseObjectService<Analysis, String> {
  ...
  List<Analysis> getAnalysisByTestIdAndTestSectionIdsAndStartedInDateRange(
      Date lowDate, Date highDate, String testId, List<Integer> testScectionIds);
  ...
  List<Analysis> getAnalysesBySampleItemsExcludingByStatusIds(
      SampleItem sampleItem, Set<Integer> statusIds);
  ...
  List<Analysis> getAnalysesBySampleStatusIdExcludingByStatusId(
      String statusId, Set<Integer> statusIds);

  List<Analysis> getAnalysesBySampleItemIdAndStatusId(String sampleItemId, String statusId);

  List<Analysis> getAnalysisStartedOnExcludedByStatusId(
      Date collectionDate, Set<Integer> statusIds);
  ...
  List<Analysis> getAllAnalysisByTestsAndStatus(
      List<Integer> list, List<Integer> analysisStatusList, List<Integer> sampleStatusList);

  List<Analysis> get(List<String> value);

  List<Analysis> getAllAnalysisByTestsAndStatusAndCompletedDateRange(
      List<Integer> nfsTestIdList,
