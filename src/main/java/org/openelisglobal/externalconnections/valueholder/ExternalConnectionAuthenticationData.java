...
public abstract class ExternalConnectionAuthenticationData extends BaseObject<Integer> {
  ...
  @GeneratedValue(
      ...
      generator = "external_connection_authentication_data_generator")
  @SequenceGenerator(
      name = "external_connection_authentication_data_generator",
      sequenceName = "external_connection_authentication_data_seq",
      allocationSize = 1)
  private Integer id;
