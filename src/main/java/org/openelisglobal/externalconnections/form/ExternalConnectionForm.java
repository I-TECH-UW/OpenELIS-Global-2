...
public class ExternalConnectionForm extends BaseForm {
  ...
  @Valid private ExternalConnection externalConnection;

  @Valid private BasicAuthenticationData basicAuthenticationData;

  @Valid private CertificateAuthenticationData certificateAuthenticationData;

  @Valid private List<ExternalConnectionContact> externalConnectionContacts;
  ...
  public void setCertificateAuthenticationData(
  ...
  public void setExternalConnectionContacts(
