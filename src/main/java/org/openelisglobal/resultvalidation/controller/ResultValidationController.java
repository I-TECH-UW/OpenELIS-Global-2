...
public class ResultValidationController extends BaseResultValidationController {
  ...
  private static final String[] ALLOWED_FIELDS =
      new String[] {
        ...
        "resultList*.lowerCritical",
        "resultList*.higherCritical",
  ...
  public ModelAndView showResultValidation(
  ...
  private ModelAndView getResultValidation(HttpServletRequest request, ResultValidationForm form)
    ...
    if (GenericValidator.isBlankOrNull(newPage)) {
      ...
      if (!(GenericValidator.isBlankOrNull(form.getTestSectionId())
        ...
        int count =
            resultsValidationUtility.getCountResultValidationList(
                getValidationStatus(), form.getTestSectionId());
  ...
  public ModelAndView showResultValidationSave(
      HttpServletRequest request,
      @ModelAttribute("form") @Validated(ResultValidationForm.ResultValidation.class)
