...
public class AccessionValidationController extends BaseController {
  ...
  public ModelAndView showAccessionValidation(
      HttpServletRequest request, AccessionValidationForm form)
    ...
    if (GenericValidator.isBlankOrNull(newPage)) {
      ...
      if (!GenericValidator.isBlankOrNull(accessionNumber)) {
        ...
        ResultsValidationUtility resultsUtility =
        ...
        if (!GenericValidator.isBlankOrNull(sample.getId())) {
          ...
          List<AnalysisItem> resultsAnalysises =
              resultsUtility.getValidationAnalysisBySample(sample);
          List<AnalysisItem> filteredresultList =
  ...
  private Errors validateAll(
      HttpServletRequest request,
      Errors errors,
      AccessionValidationForm form,
