...
public class AccessionValidationRangeController extends BaseResultValidationController {
  ...
  public AccessionValidationRangeController(
  ...
  @RequestMapping(
      value = {"/AccessionValidationRange", "/ResultValidationByTestDate"},
      method = RequestMethod.GET)
  public ModelAndView showAccessionValidationRange(
      HttpServletRequest request,
      @ModelAttribute("form") @Validated(ResultValidationForm.ResultValidation.class)
          ResultValidationForm oldForm)
  ...
  public ModelAndView showAccessionValidationRangeSave(
      HttpServletRequest request,
      @ModelAttribute("form") @Validated(ResultValidationForm.ResultValidation.class)
