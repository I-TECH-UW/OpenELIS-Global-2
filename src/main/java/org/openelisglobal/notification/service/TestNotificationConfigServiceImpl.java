...
@Service
public class TestNotificationConfigServiceImpl
    extends AuditableBaseObjectServiceImpl<TestNotificationConfig, Integer>
    implements TestNotificationConfigService {

  @Autowired private TestNotificationConfigDAO baseDAO;
  ...
  public TestNotificationConfig saveTestNotificationConfigActiveStatuses(
    ...
    if (targetTestNotificationConfig.getId() != null) {
      ...
      if (templateId != null) {
        oldConfig.setDefaultPayloadTemplate(
            notificationPayloadTemplateService.get(
                targetTestNotificationConfig.getDefaultPayloadTemplate().getId()));
      }
    }

    oldConfig
        .getPatientEmail()
        .setActive(targetTestNotificationConfig.getPatientEmail().getActive());
    oldConfig.getPatientSMS().setActive(targetTestNotificationConfig.getPatientSMS().getActive());
    oldConfig
        .getProviderEmail()
        .setActive(targetTestNotificationConfig.getProviderEmail().getActive());
  ...
  @Override
  @Transactional
  public void saveTestNotificationConfigsActiveStatuses(
  ...
  @Override
  @Transactional
  public void removeEmptyPayloadTemplates(
      TestNotificationConfig newTestNotificationConfig, String sysUserId) {
    TestNotificationConfig oldConfig;
    if (newTestNotificationConfig.getId() != null) {
      ...
      for (NotificationConfigOption newOption : newTestNotificationConfig.getOptions()) {
        if (testDefaultEmpty(newOption.getPayloadTemplate())) {
          NotificationConfigOption oldOption =
              oldConfig.getOptionFor(
                  newOption.getNotificationNature(),
                  newOption.getNotificationMethod(),
  ...
  @Override
  @Transactional
  public void updatePayloadTemplatesMessageAndSubject(
      TestNotificationConfig newTestNotificationConfig, String sysUserId) {
    TestNotificationConfig oldConfig;
    ...
    if (newTestNotificationConfig.getId() != null) {
      ...
      NotificationPayloadTemplate newPayloadTemplate =
          newTestNotificationConfig.getDefaultPayloadTemplate();
  ...
  public void saveStatusAndMessages(TestNotificationConfig config, String sysUserId) {
    TestNotificationConfig savedConfig =
        saveTestNotificationConfigActiveStatuses(config, sysUserId);
