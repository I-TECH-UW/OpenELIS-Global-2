...
public interface AnalysisNotificationConfigService
    extends BaseObjectService<AnalysisNotificationConfig, Integer> {

  Optional<AnalysisNotificationConfig> getAnalysisNotificationConfigForAnalysisId(
      String analysisId);

  List<AnalysisNotificationConfig> getAnalysisNotificationConfigForAnalysisId(
