...
@Controller
public class TestNotificationConfigMenuController
    extends BaseMenuController<TestNotificationConfig> {

  private static final String[] ALLOWED_FIELDS =
      new String[] {
        "menuList*.id",
        "menuList*.test.id",
        "menuList*.providerSMS.active",
        "menuList*.providerEmail.active",
        "menuList*.patientEmail.active",
        "menuList*.patientSMS.active",
        "menuList*.defaultPayloadTemplate.id"
      };
  ...
  public ModelAndView updateNotificationConfig(
    ...
    try {
      testNotificationConfigService.saveTestNotificationConfigsActiveStatuses(
          form.getMenuList(), this.getSysUserId(request));
  ...
  @Override
  protected List<TestNotificationConfig> createMenuList(
      AdminOptionMenuForm<TestNotificationConfig> form, HttpServletRequest request) {
    ...
    for (Test test : allOrderableTests) {
      TestNotificationConfig testNotificationConfig =
          testNotificationConfigService
              .getTestNotificationConfigForTestId(test.getId())
