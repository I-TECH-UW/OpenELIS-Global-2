...
public class AnalysisNotificationConfig extends NotificationConfig<Analysis> {
  ...
  @GeneratedValue(
      ...
      generator = "analysis_notification_config_generator")
  @SequenceGenerator(
      name = "analysis_notification_config_generator",
      sequenceName = "analysis_notification_config_seq",
      allocationSize = 1)
  private Integer id;
  ...
  @JoinTable(
      name = "analysis_notification_config_config_option",
      joinColumns = @JoinColumn(name = "analysis_notification_config_id"),
