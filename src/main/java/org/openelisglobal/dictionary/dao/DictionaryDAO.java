...
public interface DictionaryDAO extends BaseDAO<Dictionary, String> {
  ...
  //	public void updateData(Dictionary dictionary, boolean isDictionaryFrozenCheckRequired) throws
  ...
  public List<Dictionary> getDictionaryEntrysByCategoryAbbreviation(
      String filter, String dictionaryCategory) throws LIMSRuntimeException;

  // bugzilla 2063
  /**
   * A list of Dictionary entries that belong to the same dictionary category found by category name
   * and ordered by the resource in the message file. Numerically if the resource starts with an
   * number; alphabetically, if not.
   *
  ...
  public List<Dictionary> getDictionaryEntrysByCategoryNameLocalizedSort(
      String dictionaryCategoryName) throws LIMSRuntimeException;

  /**
   * A more complex lower level version of getting entries when you want to find them by some field
   * and maybe sort by entry value.
   *
   * @param fieldName - the bean name of the field to match
   * @param fieldValue - value to match with fieldName
   * @param orderByDictEntry - what to order by TRUE => dictEntry field, FALSE => id. Either will be
   *     in ascending order.
  ...
  // bugzilla 1367
  //	public Dictionary getDictionaryByDictEntry(Dictionary dictionary, boolean ignoreCase) throws
  // LIMSRuntimeException;
  ...
  // bugzilla 1413
  //	public List getPagesOfSearchedDictionarys(int startRecNo, String searchString) throws
  // LIMSRuntimeException;
  ...
  //	public List<Dictionary> getDictionaryEntriesByCategoryId(String categoryId) throws
  // LIMSRuntimeException;

  public Dictionary getDictionaryById(String dictionaryId) throws LIMSRuntimeException;

  //	public Dictionary getDictionaryEntrysByNameAndCategoryDescription(String dictionaryName, String
  // categoryDescription)
  //			throws LIMSRuntimeException;
