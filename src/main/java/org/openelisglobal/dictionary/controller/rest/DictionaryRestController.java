...
public class DictionaryRestController extends BaseController {
  ...
  public DictionaryForm showDictionary(
      HttpServletRequest request, @ModelAttribute("dictform") BaseForm oldForm)
  ...
  public ResponseEntity<?> showUpdateDictionary(
      HttpServletRequest request,
      @RequestBody @Valid DictionaryForm form,
