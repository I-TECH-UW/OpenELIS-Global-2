...
@Service
public class PatientIdentityServiceImpl
    extends AuditableBaseObjectServiceImpl<PatientIdentity, String>
    implements PatientIdentityService {
  @Autowired protected PatientIdentityDAO baseObjectDAO;
  ...
  public PatientIdentity getPatitentIdentityForPatientAndType(
      String patientId, String identityTypeId) {
    return getBaseObjectDAO().getPatitentIdentityForPatientAndType(patientId, identityTypeId);
  }

  @Override
  @Transactional(readOnly = true)
  public List<PatientIdentity> getPatientIdentitiesByValueAndType(
      String value, String identityType) {
