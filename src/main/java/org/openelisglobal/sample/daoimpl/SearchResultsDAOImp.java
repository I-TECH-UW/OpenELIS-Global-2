...
public class SearchResultsDAOImp implements SearchResultsDAO {
  ...
  @Transactional
  public List<PatientSearchResults> getSearchResultsByGUID(
      String lastName,
      String firstName,
      String STNumber,
  ...
  public List<PatientSearchResults> getSearchResults(
    ...
    try {
      ...
      query.setParameter(
          ID_TYPE_FOR_ST, Integer.valueOf(PatientIdentityTypeMap.getInstance().getIDForType("ST")));
      query.setParameter(
  ...
  private String buildQueryString(
    ...
    queryBuilder.append(
        "select p.id, pr.first_name, pr.last_name, p.gender, p.entered_birth_date, p.national_id,"
