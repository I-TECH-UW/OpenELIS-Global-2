...
public class SampleOrderItem implements Serializable {
  ...
  @SafeHtml(
      ...
      groups = {
        SampleBatchEntryForm.SampleBatchEntrySetup.class,
  ...
  @OptionalNotBlank(
      formFields = {Field.SampleEntryUseRequestDate},
      groups = {SamplePatientEntryForm.SamplePatientEntry.class, SampleEditForm.SampleEdit.class})
  @ValidDate(
