...
public class SampleEditFormValidator implements Validator {
  ...
  public void validate(Object target, Errors errors) {
    ...
    if (!ValidationResults.SUCCESS.equals(
        AccessionNumberUtil.correctFormat(maxAccessionNumberArray[0], false))) {
    ...
    ValidationHelper.validateFieldMinMax(
        form.getNonEditableAccession(),
        "nonEditableAccession",
        errors,
        invariantLength,
        invariantLength);

    ValidationHelper.validateFieldMinMax(
        form.getMaxAccessionLength(),
        "maxAccessionLength",
        errors,
        changeableLength + invariantLength,
        changeableLength + invariantLength);
  }
