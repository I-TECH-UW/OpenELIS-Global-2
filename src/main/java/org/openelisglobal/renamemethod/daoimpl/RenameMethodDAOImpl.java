...
//	}
	...
	public List<RenameMethod> getAllMethods() throws LIMSRuntimeException {
        List<RenameMethod> list = null;
    ...
    public RenameMethod getMethodById(String methodId) {
        try {
            RenameMethod method = entityManager.unwrap(Session.class).get(RenameMethod.class, methodId);
