...
@PropertySource(value = "/build/common.properties", ignoreResourceNotFound = true)
@PropertySource(value ="file:/run/secrets/common.properties", ignoreResourceNotFound = true)
