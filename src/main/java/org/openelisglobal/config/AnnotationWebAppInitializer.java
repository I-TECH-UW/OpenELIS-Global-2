...
public class AnnotationWebAppInitializer implements WebApplicationInitializer {
  ...
  private void setupServlets(
    ...
    ServletRegistration.Dynamic ajaxTextServlet =
        servletContext.addServlet("ajaxText", AjaxTextServlet.class);
    ajaxTextServlet.setLoadOnStartup(++startupOrder);
    ajaxTextServlet.addMapping("/ajaxText");

    ServletRegistration.Dynamic ajaxXMLServlet =
        servletContext.addServlet("ajaxXML", AjaxXMLServlet.class);
    ajaxXMLServlet.setLoadOnStartup(++startupOrder);
    ajaxXMLServlet.addMapping("/ajaxXML");

    ServletRegistration.Dynamic ajaxQueryXMLServlet =
        servletContext.addServlet("ajaxQueryXML", AjaxQueryXMLServlet.class);
    ...
    ServletRegistration.Dynamic reportsServlet =
        servletContext.addServlet("reportsServlet", ReportsServlet.class);
    reportsServlet.setLoadOnStartup(++startupOrder);
    reportsServlet.addMapping("/reportsServlet");

    ServletRegistration.Dynamic ajaxDataXMLLServlet =
        servletContext.addServlet(
            "ajaxDataXML", org.openelisglobal.common.servlet.data.AjaxXMLServlet.class);
    ...
    ServletRegistration.Dynamic metricServicesServlet =
        servletContext.addServlet("MetricServicesServlet", MetricServicesServlet.class);
    metricServicesServlet.setLoadOnStartup(++startupOrder);
    metricServicesServlet.addMapping("/MetricServices");

    ServletRegistration.Dynamic indicatorAggregationServlet =
        servletContext.addServlet(
            "IndicatorAggregationServlet", IndicatorAggregationReportingServlet.class);
    ...
    ServletRegistration.Dynamic orderServlet =
        servletContext.addServlet("OrderRequestServlet", OrderServlet.class);
    orderServlet.setLoadOnStartup(++startupOrder);
    orderServlet.addMapping("/OrderRequest");

    ServletRegistration.Dynamic orderRequestRawServlet =
        servletContext.addServlet("OrderRequestRawServlet", OrderRawServlet.class);
    orderRequestRawServlet.setLoadOnStartup(++startupOrder);
    orderRequestRawServlet.addMapping("/OrderRequest_Raw");

    ServletRegistration.Dynamic labelMakerServlet =
        servletContext.addServlet("LabelMakerServlet", LabelMakerServlet.class);
