...
public class PermissionModuleServiceImpl implements PermissionModuleService<PermissionModule> {
  ...
  @Autowired protected SystemUserModuleService systemUserService;

  @Autowired protected RoleModuleService roleModuleService;
  ...
  @Override
  @Transactional(readOnly = true)
  public List<PermissionModule> getAllMatchingOrdered(
      String propertyName, Object propertyValue, String orderProperty, boolean descending) {
    return getActivePermissionModule()
        .getAllMatchingOrdered(propertyName, propertyValue, orderProperty, descending);
  }
  ...
  public List<PermissionModule> getAllMatchingOrdered(
    ...
    return getActivePermissionModule()
        .getAllMatchingOrdered(propertyName, propertyValue, orderProperties, descending);
  }
  ...
  public List<PermissionModule> getAllMatchingOrdered(
    ...
    return getActivePermissionModule()
        .getAllMatchingOrdered(propertyValues, orderProperty, descending);
  }
  ...
  public List<PermissionModule> getAllMatchingOrdered(
    ...
    return getActivePermissionModule()
        .getAllMatchingOrdered(propertyValues, orderProperties, descending);
  }
  ...
  @Override
  @Transactional(readOnly = true)
  public List<PermissionModule> getMatchingPage(
      String propertyName, Object propertyValue, int pageNumber) {
  ...
  @Transactional(readOnly = true)
  public List<PermissionModule> getMatchingPage(
      Map<String, Object> propertyValues, int pageNumber) {
  ...
  @Override
  @Transactional(readOnly = true)
  public List<PermissionModule> getOrderedPage(
  ...
  @Override
  @Transactional(readOnly = true)
  public List<PermissionModule> getMatchingOrderedPage(
      String propertyName,
      ...
      int pageNumber) {
    return getActivePermissionModule()
        .getMatchingOrderedPage(propertyName, propertyValue, orderProperty, descending, pageNumber);
  }
  ...
  public List<PermissionModule> getMatchingOrderedPage(
      ...
      int pageNumber) {
    return getActivePermissionModule()
        .getMatchingOrderedPage(
            propertyName, propertyValue, orderProperties, descending, pageNumber);
  }
  ...
  public List<PermissionModule> getMatchingOrderedPage(
      ...
      int pageNumber) {
    return getActivePermissionModule()
        .getMatchingOrderedPage(propertyValues, orderProperty, descending, pageNumber);
  }
  ...
  public List<PermissionModule> getMatchingOrderedPage(
      ...
      int pageNumber) {
    return getActivePermissionModule()
        .getMatchingOrderedPage(propertyValues, orderProperties, descending, pageNumber);
  }
