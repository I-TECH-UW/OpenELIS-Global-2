...
public class ResultCalculation extends BaseObject<Integer> {
  ...
  @SequenceGenerator(
      name = "result_calculation_generator",
      sequenceName = "result_calculation_seq",
      allocationSize = 1)
  @Column(name = "id")
  private Integer id;
  ...
  @CollectionTable(
      ...
      joinColumns = @JoinColumn(name = "result_calculation_id", referencedColumnName = "id"))
  @Column(name = "test_id")
  private Set<Test> test;

  @ElementCollection
  @CollectionTable(
      name = "test_result_map",
      joinColumns = @JoinColumn(name = "result_calculation_id", referencedColumnName = "id"))
