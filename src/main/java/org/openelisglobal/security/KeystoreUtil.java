...
public class KeystoreUtil {
  ...
  public static PrivateKey getPrivateKeyFromKeyStore(
      KeyStore keyStore, char[] keystorePwd, String keyAlias, char[] keyPwd)
  ...
  public static Certificate getCertFromKeyStore(KeyStore keyStore, char[] keyPwd)
      throws CertificateException, NoSuchAlgorithmException, KeyStoreException, IOException,
          UnrecoverableKeyException {
    String alias = keyStore.aliases().nextElement();
  ...
  public static KeyCertPair getKeyCertFromKeystore(
      KeyStore keyStore, char[] keystorePwd, String keyAlias, char[] keyPwd)
      throws CertificateException, NoSuchAlgorithmException, KeyStoreException, IOException,
          UnrecoverableKeyException {
    String alias = keyStore.aliases().nextElement();
    return new KeyCertPair(
        (PrivateKey) keyStore.getKey(alias, keyPwd), keyStore.getCertificate(alias));
  }

  public static KeyCertPair getKeyCertFromKeystore(KeyStore keyStore, char[] keystorePwd)
      throws CertificateException, NoSuchAlgorithmException, KeyStoreException, IOException,
          UnrecoverableKeyException {
    String alias = keyStore.aliases().nextElement();
    return new KeyCertPair(
        (PrivateKey) keyStore.getKey(alias, keystorePwd), keyStore.getCertificate(alias));
  }
