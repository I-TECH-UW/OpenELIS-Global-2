...
/**
 * Stores information about a field that appears on a bar code label examples of how it appears on
 * labels: name: value (displayFieldName = true) value (displayFieldName = false)
 *
 * @author Caleb
 */
