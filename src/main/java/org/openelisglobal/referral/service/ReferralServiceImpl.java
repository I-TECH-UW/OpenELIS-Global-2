...
@Service
public class ReferralServiceImpl extends AuditableBaseObjectServiceImpl<Referral, String>
    implements ReferralService {
  @Autowired protected ReferralDAO baseObjectDAO;
  ...
  @Override
  @Transactional(readOnly = true)
  public List<Referral> getReferralsByOrganization(
  ...
  public List<Referral> getReferralsByTestAndDate(
      ...
      List<String> testIds) {
    return baseObjectDAO.getReferralsByTestAndDate(
        dateType, startTimestamp, endTimestamp, testUnitIds, testIds);
  }
  ...
  private List<Referral> getReferralsByTestAndDate(ReferredOutTestsForm form) {
    ...
    return getReferralsByTestAndDate(
        form.getDateType(), startTimestamp, endTimestamp, form.getTestUnitIds(), form.getTestIds());
  }
  ...
  public ReferralDisplayItem convertToDisplayItem(Referral referral) {
    ...
    referralItem.setReferringTestName(
        analysis.getTest().getLocalizedTestName().getLocalizedValue());
