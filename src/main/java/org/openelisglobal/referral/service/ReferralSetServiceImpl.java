...
public class ReferralSetServiceImpl implements ReferralSetService {
  ...
  @Autowired private ReferralTypeService referralTypeService;
  ...
  @Transactional
  @Override
  public void updateReferralSets(
  ...
  private void setStatusOfParentSamples(
      List<Sample> modifiedSamples, Set<Sample> parentSamples, String sysUserId) {
  ...
  @Override
  @Transactional
  public void createSaveReferralSetsSamplePatientEntry(
