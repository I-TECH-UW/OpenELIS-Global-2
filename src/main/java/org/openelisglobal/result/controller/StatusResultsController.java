...
public class StatusResultsController extends BaseController {
  ...
  private static final ConfigurationProperties configProperties =
  ...
  public ModelAndView showStatusResults(
      HttpServletRequest request, @Valid StatusResultsForm form, BindingResult result)
  ...
  private List<TestResultItem> setSearchResults(
      StatusResultsForm form, ResultsLoadUtility resultsUtility)
      throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
  ...
  private List<TestResultItem> getSelectedTests(
      StatusResultsForm form, ResultsLoadUtility resultsUtility) {
  ...
  private List<Analysis> getAnalysisListForSampleItems(List<Sample> sampleList) {
    ...
    for (Sample sample : sampleList) {
      ...
      for (SampleItem sampleItem : sampleItemList) {
        List<Analysis> analysisListForItem =
  ...
  private List<Analysis> getAnalysisForSampleStatus(String sampleStatus) {
    return analysisService.getAnalysesBySampleStatusIdExcludingByStatusId(
  ...
  private List<TestResultItem> buildTestItems(
      List<Analysis> analysisList, ResultsLoadUtility resultsUtility) {
    if (analysisList.isEmpty()) {
      return new ArrayList<>();
    }
