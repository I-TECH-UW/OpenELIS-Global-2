...
public class ResultUtil {
  ...
  private static final TestAnalyteService testAnalyteService =
      SpringContext.getBean(TestAnalyteService.class);
  ...
  public static TestAnalyte getTestAnalyteForResult(Result result) {
    ...
    if (result.getTestResult() != null) {
      List<TestAnalyte> testAnalyteList =
          testAnalyteService.getAllTestAnalytesPerTest(result.getTestResult().getTest());
