...
public class ResultDAOImpl extends BaseDAOImpl<Result, String> implements ResultDAO {
  ...
  public List<Result> getResultsForTestAndSample(String sampleId, String testId) {
    String sql =
        "FROM Result r WHERE r.analysis.sampleItem.sample.id = :sampleId AND r.testResult.test.id ="
            + " :testId";
  ...
  public List<Result> getResultsForTestInDateRange(String testId, Date startDate, Date endDate)
      throws LIMSRuntimeException {
    String sql =
        "FROM Result r WHERE r.analysis.test.id = :testId AND r.lastupdated BETWEEN :lowDate AND"
            + " :highDate";
  ...
  public List<Result> getResultsForPanelInDateRange(String panelId, Date lowDate, Date highDate)
      throws LIMSRuntimeException {
    String sql =
        "FROM Result r WHERE r.analysis.panel.id = :panelId AND r.lastupdated BETWEEN :lowDate AND"
  ...
  public List<Result> getResultsForTestSectionInDateRange(
    ...
    String sql =
        "FROM Result r WHERE r.analysis.testSection.id = :testSectionId AND r.lastupdated BETWEEN"
