...
public class AnalyzerResultsForm extends BaseForm implements IPagingForm {
  ...
  @Valid private PagingBean paging;

  @Valid private List<AnalyzerResultItem> resultList;

  @SafeHtml(level = SafeHtml.SafeListLevel.NONE)
  private String type;

  @NotNull private Boolean displayNotFoundMsg = false;

  @NotNull private Boolean displayMissingTestMsg = false;
