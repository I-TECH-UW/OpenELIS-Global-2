...
@Service
public class ResultSignatureServiceImpl
    extends AuditableBaseObjectServiceImpl<ResultSignature, String>
    implements ResultSignatureService {
  @Autowired protected ResultSignatureDAO baseObjectDAO;
