...
@Service
public class ResultInventoryServiceImpl
    extends AuditableBaseObjectServiceImpl<ResultInventory, String>
    implements ResultInventoryService {
  @Autowired protected ResultInventoryDAO baseObjectDAO;
