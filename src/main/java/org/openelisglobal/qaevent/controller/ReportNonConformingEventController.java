...
public class ReportNonConformingEventController extends BaseController {
  ...
  public ModelAndView showReportNonConformingEvent(
      @Valid @ModelAttribute("form") NonConformingEventForm oldForm,
  ...
  private void initForm(String labOrderNumber, String sampleItemIds, NonConformingEventForm form)
    ...
    NcEvent event =
        nonConformingEventWorker.create(
            labOrderNumber,
            Arrays.asList(sampleItemIds.split(",")),
            systemUser.getId(),
            form.getNceNumber());
