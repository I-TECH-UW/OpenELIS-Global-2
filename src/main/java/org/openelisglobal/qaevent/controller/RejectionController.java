...
public class RejectionController extends BaseController {
  ...
  public ModelAndView showRejectionForm(
      HttpServletRequest request, @Validated RejectionForm form, BindingResult result)
  ...
  private void setupForm(RejectionForm form)
      throws LIMSInvalidConfigurationException, IllegalAccessException, InvocationTargetException,
          NoSuchMethodException {
  ...
  public ModelAndView showNonConformityUpdate(
      ...
      @ModelAttribute("form") @Validated RejectionForm form,
    ...
    try {
      IAccessionNumberGenerator accessionValidator =
      ...
      Organization organization =
          ObjectUtils.isNotEmpty(form.getOrganizationId())
