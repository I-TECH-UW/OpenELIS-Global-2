...
public class ObservationHistoryDAOImpl extends BaseDAOImpl<ObservationHistory, String>
  ...
  public List<ObservationHistory> getObservationHistoryByDictonaryValues(String dictionaryValue)
    ...
    try {
      ...
      Query<ObservationHistory> query =
          entityManager.unwrap(Session.class).createQuery(sql, ObservationHistory.class);
  ...
  public List<ObservationHistory> getObservationHistoriesByPatientIdAndType(
    ...
    String sql =
        "from ObservationHistory oh where oh.patientId = :patientId and oh.observationHistoryTypeId"
  ...
  public ObservationHistory getObservationHistoriesBySampleIdAndType(
    ...
    String sql =
        "from ObservationHistory oh where oh.sampleId = :sampleId and oh.observationHistoryTypeId ="
            + " :ohTypeId";
    try {
      Query<ObservationHistory> query =
          entityManager.unwrap(Session.class).createQuery(sql, ObservationHistory.class);
  ...
  public List<ObservationHistory> getObservationHistoriesByValueAndType(
    ...
    String sql =
        "from ObservationHistory oh where oh.value = :value and oh.observationHistoryTypeId ="
  ...
  //     * are filled in.
  //     */
  //    public List<ObservationHistory> readByExample(ObservationHistory entity) throws
  ...
  protected LIMSRuntimeException createAndLogException(String methodName, Exception e) {
    LogEvent.logError(e);
    return new LIMSRuntimeException(
        "Error in " + this.getClass().getSimpleName() + " " + methodName, e);
  }
