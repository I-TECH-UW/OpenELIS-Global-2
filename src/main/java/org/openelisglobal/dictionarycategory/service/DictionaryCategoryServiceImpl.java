...
@Service
public class DictionaryCategoryServiceImpl
    extends AuditableBaseObjectServiceImpl<DictionaryCategory, String>
    implements DictionaryCategoryService {
  @Autowired protected DictionaryCategoryDAO baseObjectDAO;
