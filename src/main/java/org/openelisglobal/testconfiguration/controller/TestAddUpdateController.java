...
public class TestAddUpdateController extends BaseController {
    @RequestMapping(value = "/TestAddUpdate", method = RequestMethod.GET)
    public ModelAndView showTestAddUpdate(HttpServletRequest request, @ModelAttribute("form") TestAddForm form) {
