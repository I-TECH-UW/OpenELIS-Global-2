...
public class MethodCreateController extends BaseController {
  private static final String[] ALLOWED_FIELDS =
      new String[] {"methodEnglishName", "methodFrenchName"};

  public static final String NAME_SEPARATOR = "$";

  @Autowired private MethodService methodService;
  @Autowired private RoleService roleService;
  @Autowired private MethodCreateService methodCreateService;
  ...
  public ModelAndView postMethodCreate(
      HttpServletRequest request,
      @ModelAttribute("form") @Valid MethodCreateForm form,
    ...
    Localization localization =
        createLocalization(form.getMethodFrenchName(), identifyingName, userId);
    ...
    try {
      methodCreateService.insertMethod(
          localization,
          method,
          workplanModule,
          resultModule,
