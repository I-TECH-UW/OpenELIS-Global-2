...
public class TestSectionCreateController extends BaseController {
  ...
  private static final String[] ALLOWED_FIELDS =
      new String[] {"testUnitEnglishName", "testUnitFrenchName"};

  public static final String NAME_SEPARATOR = "$";

  @Autowired private TestSectionService testSectionService;
  @Autowired private RoleService roleService;
  @Autowired private TestSectionCreateService testSectionCreateService;
  ...
  public ModelAndView postTestSectionCreate(
      HttpServletRequest request,
      @ModelAttribute("form") @Valid TestSectionCreateForm form,
    ...
    Localization localization =
        createLocalization(form.getTestUnitFrenchName(), identifyingName, userId);
    ...
    try {
      testSectionCreateService.insertTestSection(
          localization,
          testSection,
          workplanModule,
          resultModule,
