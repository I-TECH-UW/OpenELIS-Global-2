...
@RestController
@RequestMapping("/rest")
public class TestCatalogRestController extends BaseController {
    ...
    @GetMapping(value = "/TestCatalog", produces = MediaType.APPLICATION_JSON_VALUE)
    public TestCatalogForm showTestCatalog(HttpServletRequest request) {
