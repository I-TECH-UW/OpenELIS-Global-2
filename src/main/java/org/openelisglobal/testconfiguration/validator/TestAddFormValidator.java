    ...
    public void validate(Object target, Errors errors) {
        ...
        try {
            ...
            if (!JSONUtils.isEmpty(newTest)) {
                ...
                ValidationHelper.validateField(String.valueOf(newTest.get("testNameEnglish")), "JsonWad",
                        "testNameEnglish", errors, true, 255);

                ValidationHelper.validateField(String.valueOf(newTest.get("testNameFrench")), "JsonWad",
                ...
                ValidationHelper.validateIdField(String.valueOf(newTest.get("resultType")), "JsonWad", "resultType",
                        errors, true);

                ValidationHelper.validateYNField(String.valueOf(newTest.get("orderable")), "JsonWad", "orderable",
                        errors);
                ...
                for (int i = 0; i < sampleTypes.size(); ++i) {
                    ...
                    ValidationHelper.validateIdField(String.valueOf(sampleType.get("typeId")), "JsonWad", errors,
                            false);
                ...
                if (newTest.containsKey("lowValid")) {
                    ValidationHelper.validateField(String.valueOf(newTest.get("lowValid")), "JsonWad", "lowValid",
                            errors, false, 255, ValidationHelper.FLOAT_REGEX);

                    ValidationHelper.validateField(String.valueOf(newTest.get("highValid")), "JsonWad", "highValid",
                            errors, false, 255, ValidationHelper.FLOAT_REGEX);

                    ValidationHelper.validateFieldAndCharset(String.valueOf(newTest.get("significantDigits")),
                            "JsonWad", errors, false, 2, "0-9");
                    ...
                    for (int i = 0; i < resultLimits.size(); ++i) {
                        ...
                        if ((Boolean) resultLimit.get("gender")) {
                            ValidationHelper.validateField(String.valueOf(resultLimit.get("lowNormalFemale")),
                                    "JsonWad", "result limit [" + i + "] lowNormalFemale", errors, false, 255,
                                    ValidationHelper.FLOAT_REGEX);

                            ValidationHelper.validateField(String.valueOf(resultLimit.get("highNormalFemale")),
