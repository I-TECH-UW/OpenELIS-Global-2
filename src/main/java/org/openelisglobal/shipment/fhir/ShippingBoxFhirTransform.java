...
public class ShippingBoxFhirTransform {
    ...
    /**
     * The destination laboratory's Organization UUID and the sending laboratory's
     * name as flat extensions, alongside the contained Location below, so a
     * receiving site that reads either form recognises the consignment.
     */
    ...
    public SupplyDelivery transformToSupplyDelivery(ShippingBox box) {
        ...
        // Source org — the sending laboratory's configured name, for receiver display.
