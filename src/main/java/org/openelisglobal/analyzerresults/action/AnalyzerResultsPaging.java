...
public class AnalyzerResultsPaging {
  ...
  public void setDatabaseResults(
      HttpServletRequest request, AnalyzerResultsForm form, List<AnalyzerResultItem> tests)
  ...
  private static class TestItemPageHelper
      implements IPageDivider<List<AnalyzerResultItem>>,
          IPageUpdater<List<AnalyzerResultItem>>,
          IPageFlattener<List<AnalyzerResultItem>> {

    @Override
    public void createPages(
        List<AnalyzerResultItem> tests, List<List<AnalyzerResultItem>> pagedResults) {
    ...
    public void updateCache(
        List<AnalyzerResultItem> cacheItems, List<AnalyzerResultItem> clientItems) {
