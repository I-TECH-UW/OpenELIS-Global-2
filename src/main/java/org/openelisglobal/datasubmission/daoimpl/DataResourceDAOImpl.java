...
@Component
@Transactional
public class DataResourceDAOImpl extends BaseDAOImpl<DataResource, String>
    implements DataResourceDAO {
  ...
  //		try {
  //			DataResource resourceClone = entityManager.unwrap(Session.class).get(DataResource.class,
  // resource.getId());
