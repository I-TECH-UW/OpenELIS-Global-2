...
@Service
public class TypeOfSampleTestServiceImpl
    extends AuditableBaseObjectServiceImpl<TypeOfSampleTest, String>
    implements TypeOfSampleTestService {
  @Autowired protected TypeOfSampleTestDAO baseObjectDAO;
