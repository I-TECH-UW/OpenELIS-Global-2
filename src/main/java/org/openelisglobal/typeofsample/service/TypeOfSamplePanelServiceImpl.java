...
@Service
public class TypeOfSamplePanelServiceImpl
    extends AuditableBaseObjectServiceImpl<TypeOfSamplePanel, String>
    implements TypeOfSamplePanelService {
  @Autowired protected TypeOfSamplePanelDAO baseObjectDAO;
