...
@Component
@Transactional
public class TypeOfSamplePanelDAOImpl extends BaseDAOImpl<TypeOfSamplePanel, String>
    implements TypeOfSamplePanelDAO {
  ...
  public void getData(TypeOfSamplePanel typeOfSamplePanel) throws LIMSRuntimeException {
    ...
    try {
      TypeOfSamplePanel tos =
          entityManager
              .unwrap(Session.class)
              .get(TypeOfSamplePanel.class, typeOfSamplePanel.getId());
      if (tos != null) {
  ...
  public List<TypeOfSamplePanel> getAllTypeOfSamplePanels() throws LIMSRuntimeException {
    ...
    try {
      ...
      Query<TypeOfSamplePanel> query =
          entityManager.unwrap(Session.class).createQuery(sql, TypeOfSamplePanel.class);
      list = query.list();
  ...
  public List<TypeOfSamplePanel> getTypeOfSamplePanelsForSampleType(String sampleType) {
    ...
    String sql =
        "from TypeOfSamplePanel tp where tp.typeOfSampleId = :sampleId order by tp.panelId";
    ...
    try {
      ...
      throw new LIMSRuntimeException(
          "Error in TypeOfSamplePanelDAOImpl getTypeOfSamplePanelsForSampleType", e);
    }
