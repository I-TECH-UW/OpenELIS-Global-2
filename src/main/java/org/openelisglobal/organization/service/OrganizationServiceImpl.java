...
public class OrganizationServiceImpl extends AuditableBaseObjectServiceImpl<Organization, String>
  ...
  @Autowired protected OrganizationDAO baseObjectDAO;
  @Autowired private OrganizationOrganizationTypeDAO organizationOrganizationTypeDAO;
  ...
  @Override
  @Transactional(readOnly = true)
  public List<Organization> getPagesOfSearchedOrganizations(
      int startingRecNo, String searchString) {
  ...
  public Organization getOrganizationByLocalAbbreviation(
      Organization organization, boolean ignoreCase) {
  ...
  public List<Organization> getOrganizationsByTypeName(
      String orderByProperty, String referralOrgType) {
