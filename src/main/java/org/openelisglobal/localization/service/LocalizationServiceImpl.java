...
public class LocalizationServiceImpl extends AuditableBaseObjectServiceImpl<Localization, String>
  ...
  @Autowired private LocalizationDAO baseObjectDAO;
  ...
  public boolean languageChanged(Localization localization, Localization newLocalization) {
    ...
    for (Locale locale : newLocalization.getLocalesWithValue()) {
      if (!newLocalization
          ...
          .equals(localization.getLocalizedValue(locale))) {
   ...
   * @return true if the object can be found and an update is needed. False if the id the service
   *     was created with is not valid or the french or english is empty or null or the french and
   *     english match what is already in the object
   */
  ...
  public static Localization createNewLocalization(
      String english, String french, LocalizationType type) {
