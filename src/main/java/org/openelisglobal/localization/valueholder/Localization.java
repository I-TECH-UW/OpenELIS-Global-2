...
public class Localization extends BaseObject<String> {
  ...
  public List<String> getLocalesAndValuesOfLocalesWithValues() {
    ...
    for (Locale localeWithValue : getLocalesWithValueSortedForDisplay()) {
      localizationValues.add(
          localeWithValue.getDisplayLanguage(displayLocale)
              + ": "
              + getLocalizedValue(localeWithValue));
    }
    ...
    Comparator<Locale> comparator =
        new Comparator<Locale>() {
          ...
          public int compare(Locale o1, Locale o2) {
            return o1.getDisplayLanguage(displayLocale)
                .compareTo(o2.getDisplayLanguage(displayLocale));
          }
        };
