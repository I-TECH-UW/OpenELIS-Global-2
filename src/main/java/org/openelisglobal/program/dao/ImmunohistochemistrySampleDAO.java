...
public interface ImmunohistochemistrySampleDAO
    extends BaseDAO<ImmunohistochemistrySample, Integer> {
  ...
  List<ImmunohistochemistrySample> searchWithStatusAndAccesionNumber(
