...
@Component
@Transactional
public class ProgramSampleDAOImpl extends BaseDAOImpl<ProgramSample, Integer>
    implements ProgramSampleDAO {
  ...
  public ProgramSample getProgrammeSampleBySample(Integer sampleId, String programName) {
    ...
    Query<ProgramSample> query =
        entityManager.unwrap(Session.class).createQuery(sql, ProgramSample.class);
