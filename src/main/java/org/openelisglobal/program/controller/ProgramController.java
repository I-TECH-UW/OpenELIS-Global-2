...
public class ProgramController extends BaseRestController {
    ...
    if (form.getProgram().getQuestionnaireUUID() != null) {
      form.setAdditionalOrderEntryQuestions(
          fhirUtil
              ...
              .withId(form.getProgram().getQuestionnaireUUID().toString())
              .execute());
    }
  ...
  @ResponseBody
  public Questionnaire getAdditionalEntryQuestions(
    ...
    if (programService.get(id).getQuestionnaireUUID() != null) {
      return fhirUtil
          ...
          .read()
          .resource(Questionnaire.class)
          .withId(programService.get(id).getQuestionnaireUUID().toString())
          .execute();
    }
    return null;
  }
