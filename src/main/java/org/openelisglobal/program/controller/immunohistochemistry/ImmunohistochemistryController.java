...
public class ImmunohistochemistryController extends BaseRestController {
  ...
  @Autowired private ImmunohistochemistryDisplayService immunohistochemistryDisplayService;
  @Autowired private SystemUserService systemUserService;

  @GetMapping(
      value = "/rest/immunohistochemistry/dashboard",
  ...
  public List<ImmunohistochemistryDisplayItem> getFilteredImmunohistochemistryEntries(
    ...
    return immunohistochemistrySampleService
  ...
  @GetMapping(
      value = "/rest/immunohistochemistry/dashboard/count",
      produces = MediaType.APPLICATION_JSON_VALUE)
  @ResponseBody
  public ResponseEntity<ImmunohistochemistryDashBoardCount>
      getFilteredImmunohistochemistryEntries() {
    ImmunohistochemistryDashBoardCount count = new ImmunohistochemistryDashBoardCount();
    count.setInProgress(
        immunohistochemistrySampleService.getCountWithStatus(
            Arrays.asList(ImmunohistochemistryStatus.IN_PROGRESS)));
    count.setAwaitingReview(
        immunohistochemistrySampleService.getCountWithStatus(
            Arrays.asList(ImmunohistochemistryStatus.READY_PATHOLOGIST)));
    ...
    count.setComplete(
        immunohistochemistrySampleService.getCountWithStatusBetweenDates(
            Arrays.asList(ImmunohistochemistryStatus.COMPLETED),
            weekAgoTimestamp,
            currentTimestamp));
  ...
  @PostMapping(
      value = "/rest/immunohistochemistry/assignTechnician",
      produces = MediaType.APPLICATION_JSON_VALUE)
  @ResponseBody
  public ResponseEntity<String> assignTechnician(
      @RequestParam Integer immunohistochemistrySampleId, HttpServletRequest request) {
    String currentUserId = getSysUserId(request);
    immunohistochemistrySampleService.assignTechnician(
        immunohistochemistrySampleId, systemUserService.get(currentUserId));
    return ResponseEntity.ok("ok");
  }

  @PostMapping(
      value = "/rest/immunohistochemistry/assignPathologist",
      produces = MediaType.APPLICATION_JSON_VALUE)
  @ResponseBody
  public ResponseEntity<String> assignPathologist(
      @RequestParam Integer immunohistochemistrySampleId, HttpServletRequest request) {
    String currentUserId = getSysUserId(request);
    immunohistochemistrySampleService.assignPathologist(
        immunohistochemistrySampleId, systemUserService.get(currentUserId));
    return ResponseEntity.ok("ok");
  }

  @GetMapping(
      value = "/rest/immunohistochemistry/caseView/{immunohistochemistrySampleId}",
      produces = MediaType.APPLICATION_JSON_VALUE)
  @ResponseBody
  public ImmunohistochemistryCaseViewDisplayItem getFilteredImmunohistochemistryEntries(
    ...
    return immunohistochemistryDisplayService.convertToCaseDisplayItem(
  ...
  public ImmunohistochemistrySampleForm getFilteredImmunohistochemistryEntries(
      @PathVariable("immunohistochemistrySampleId") Integer immunohistochemistrySampleId,
      @RequestBody ImmunohistochemistrySampleForm form,
