...
public class CytologySpecimenAdequacy extends BaseObject<Integer> {
  ...
  @GeneratedValue(
      ...
      generator = "cytology_specimen_adequacy_generator")
  @SequenceGenerator(
      name = "cytology_specimen_adequacy_generator",
      sequenceName = "cytology_specimen_adequacy_seq",
      allocationSize = 1)
  private Integer id;

  @ElementCollection(targetClass = String.class, fetch = FetchType.EAGER)
  @CollectionTable(
      name = "cytology_specimen_adequacy_value",
      joinColumns = @JoinColumn(name = "cytology_specimen_adequacy_id"))
