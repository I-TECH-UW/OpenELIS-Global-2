...
@Service
public class ElectronicOrderServiceImpl
    extends AuditableBaseObjectServiceImpl<ElectronicOrder, String>
    implements ElectronicOrderService {
  @Autowired protected ElectronicOrderDAO baseObjectDAO;
  @Autowired protected IStatusService statusService;
  @Autowired protected OrganizationService organizationService;
  @Autowired protected TestService testService;
  @Autowired protected FhirUtil fhirUtil;
  ...
  public List<ElectronicOrder> getAllElectronicOrdersContainingValueOrderedBy(
    ...
    List<ElectronicOrder> searchResult =
        getBaseObjectDAO().getAllElectronicOrdersContainingValueOrderedBy(searchValue, order);
  ...
  public List<ElectronicOrder> getAllElectronicOrdersContainingValuesOrderedBy(
    ...
    return getBaseObjectDAO()
        .getAllElectronicOrdersContainingValuesOrderedBy(
            accessionNumber, patientLastName, patientFirstName, gender, order);
  }
  ...
  public List<ElectronicOrder> getElectronicOrdersContainingValueExludedByOrderedBy(
    ...
    return getBaseObjectDAO()
        .getElectronicOrdersContainingValueExludedByOrderedBy(
            searchValue, exludedStatusIds, sortOrder);
  }
  ...
  public List<ElectronicOrder> getAllElectronicOrdersByDateAndStatus(
    ...
    return getBaseObjectDAO()
        .getAllElectronicOrdersByDateAndStatus(startDate, endDate, statusId, sortOrder);
  }
  ...
  public List<ElectronicOrder> getAllElectronicOrdersByTimestampAndStatus(
    ...
    return getBaseObjectDAO()
        .getAllElectronicOrdersByTimestampAndStatus(
            startTimestamp, endTimestamp, statusId, sortOrder);
  }
  ...
  public List<ElectronicOrder> searchForElectronicOrders(ElectronicOrderViewForm form) {
    switch (form.getSearchType()) {
      case IDENTIFIER:
        ...
        Bundle searchBundle =
            fhirClient
                ...
                .where(ServiceRequest.IDENTIFIER.exactly().code(form.getSearchValue()))
        ...
        List<ElectronicOrder> eOrders =
            baseObjectDAO.getAllElectronicOrdersMatchingAnyValue(
                identifierValues, nameValue, SortOrder.LAST_UPDATED_ASC);
      ...
      case DATE_STATUS:
        ...
        return getAllElectronicOrdersByTimestampAndStatus(
            startTimestamp, endTimestamp, form.getStatusId(), SortOrder.STATUS_ID);
      default:
        return null;
    }
  }
  ...
  public int getCountOfAllElectronicOrdersByDateAndStatus(
    ...
    return getBaseObjectDAO()
        .getCountOfAllElectronicOrdersByDateAndStatus(startDate, endDate, statusId);
  }
}
