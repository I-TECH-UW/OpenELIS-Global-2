...
public class FhirUtil implements FhirClientFetcher {
  ...
  public IGenericClient getLocalFhirClient() {
    IGenericClient fhirClient =
        fhirContext.newRestfulGenericClient(fhirConfig.getLocalFhirStorePath());
    return fhirClient;
  }
  ...
  public String getAccessToken(String authUrl, String authUserName, String authPassowrd)
      throws IOException {
    HttpPost httpPost = new HttpPost(authUrl);

    String json =
        String.format("{\"username\":\"%s\",\"password\":\"%s\"}", authUserName, authPassowrd);
