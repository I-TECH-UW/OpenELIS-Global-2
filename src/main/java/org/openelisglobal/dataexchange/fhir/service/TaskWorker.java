      ...
      switch (checkResult) {
        ...
        case ORDER_FOUND_INPROGRESS:
          ...
          return orderType == OrderType.CANCEL
              ? TaskResult.NON_CANCELABLE_ORDER
        ...
        case NOT_FOUND:
          if (orderType == OrderType.CANCEL) {
            ...
            insertNewOrder(
                referringOrderNumber, message, patient, priority, ExternalOrderStatus.Entered);
            return TaskResult.OK;
          }
        ...
        default:
          LogEvent.logDebug(
              ...
              "undetermined issue in correctly interpreted request: "
                  + interpretResults.get(0).toString()
                  + " check result: "
                  + checkResult
                  + " for: "
                  ...
                  + " ");
          insertNewOrder(
              referringOrderNumber, message, patient, priority, ExternalOrderStatus.NonConforming);
