...
@Component
@Transactional
public class ReferenceTablesDAOImpl extends BaseDAOImpl<ReferenceTables, String>
    implements ReferenceTablesDAO {
  ...
  public void getData(ReferenceTables referenceTables) throws LIMSRuntimeException {
    try {
      ReferenceTables reftbl =
          entityManager.unwrap(Session.class).get(ReferenceTables.class, referenceTables.getId());
      if (reftbl != null) {
  ...
  public List<ReferenceTables> getAllReferenceTables() throws LIMSRuntimeException {
    ...
    try {
      ...
      Query<ReferenceTables> query =
          entityManager.unwrap(Session.class).createQuery(sql, ReferenceTables.class);
      list = query.list();
  ...
  public List<ReferenceTables> getAllReferenceTablesForHl7Encoding() throws LIMSRuntimeException {
    ...
    try {
      ...
      throw new LIMSRuntimeException(
          "Error in ReferenceTables getAllReferenceTablesForHl7Encoding()", e);
    }
