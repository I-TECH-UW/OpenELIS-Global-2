...
public class AnalyzerTestNameCache {
  ...
  private final HashMap<String, Map<String, MappedTestName>> analyzerNameToTestNameMap =
      new HashMap<>();
  ...
  private MappedTestName createMappedTestName(
      TestService testService, AnalyzerTestMapping mapping) {
