    ...
    if (!GenericValidator.isBlankOrNull(report)) {
      if (report.equals("patientARV1")) {
        return new ReportSpecificationParameters(
            ...
            MessageUtil.getMessage("reports.label.patient.ARV.all"),
            null);
        ...
        return new ReportSpecificationParameters(
            Parameter.ACCESSION_RANGE,
            MessageUtil.getMessage("reports.label.patient.ARV.initial"),
            null);
        ...
        return new ReportSpecificationParameters(
            Parameter.ACCESSION_RANGE,
            MessageUtil.getMessage("reports.label.patient.ARV.followup"),
            null);
        ...
        return new ReportSpecificationParameters(
            new Parameter[] {
              Parameter.ACCESSION_RANGE, Parameter.USE_PATIENT_SEARCH, Parameter.USE_SITE_SEARCH
            },
            MessageUtil.getMessage("reports.label.patient.EID"),
            null);
      } else if (report.equals("patientEID2")) {
        return new ReportSpecificationParameters(
            Parameter.ACCESSION_RANGE, MessageUtil.getMessage("reports.label.patient.EID"), null);
      } else if (report.equals("patientVL1")) {
        return new ReportSpecificationParameters(
            new Parameter[] {
              Parameter.ACCESSION_RANGE, Parameter.USE_PATIENT_SEARCH, Parameter.USE_SITE_SEARCH
            },
            MessageUtil.getMessage("reports.label.patient.VL"),
            null);
        ...
        return new ReportSpecificationParameters(
            Parameter.DATE_RANGE, MessageUtil.getMessage("openreports.nonConformityReport"), null);
      } else if (isNonConformityBySectionReport(report)) {
        return new ReportSpecificationParameters(
            Parameter.DATE_RANGE,
            MessageUtil.getMessage("reports.nonConformity.bySectionReason.title"),
            null);
      } else if (report.equals("patientSpecialReport")) {
        return new ReportSpecificationParameters(
            Parameter.ACCESSION_RANGE,
            MessageUtil.getMessage("reports.specialRequest.title"),
            null);
        ...
        return new ReportSpecificationParameters(
            Parameter.DATE_RANGE, MessageUtil.getMessage("report.realisation"), null);
      } else if (report.equals("epiSurveillanceExport")) {
        return new ReportSpecificationParameters(
            Parameter.DATE_RANGE,
            MessageUtil.getMessage("banner.menu.report.epi.surveillance.export"),
            null);
