...
public class CovidResultsCSVBuilder extends CovidResultsBuilderImpl {
    ...
    private void addValueRow(Analysis analysis) {
        ...
        SampleAdditionalField  contactTracingIndexName = 
                sampleService.getSampleAdditionalFieldForSample(sample.getId(), 
...
//    
//        String srString = "";
//        if (analysis.getSampleItem().getSample().getAccessionNumber().equalsIgnoreCase("10200000000422724")) {
...
//              if (true) {
    ...
    private void convertJSONToCSV(JSONObject jsonObject, String keyPrefix, Map<String, String> valueRow, Map<Integer, String> keyMap) {
    ...
    private void convertJSONToCSV(JSONArray jsonArray, String keyPrefix, Map<String, String> valueRow, Map<Integer, String> keyMap) {
