...
public class CovidResultsCSVBuilder extends CovidResultsBuilderImpl {
  ...
  private void addValueRow(Analysis analysis) {
    ...
    SampleAdditionalField contactTracingIndexName =
        sampleService.getSampleAdditionalFieldForSample(
            sample.getId(), AdditionalFieldName.CONTACT_TRACING_INDEX_NAME);

    SampleAdditionalField contactTracingIndexRecordNumber =
        sampleService.getSampleAdditionalFieldForSample(
    ...
    valueRow.put(
        CONTACT_TRACING_INDEX_RECORD_NUMBER, contactTracingIndexRecordNumber.getFieldValue());
    ...
    //        SampleService sampleService = SpringContext.getBean(SampleService.class);
    valueRow.put(
        SAMPLE_RECEIVED_DATE_PROPERTY_NAME,
        sampleService.getReceivedDateWithTwoYearDisplay(sample));
    ...
    // ="{\"resourceType\":\"ServiceRequest\",\"status\":\"requested\",\"description\":\"{\\\"lastName\\\":\\\"Bhurosah\\\",\\\"firstName\\\":\\\"Suresh\\\",\\\"middleInitial\\\":\\\"\\\",\\\"seatNumber\\\":\\\"\\\",\\\"dateOfBirth\\\":\\\"1987-10-20\\\",\\\"sex\\\":\\\"MALE\\\",\\\"nationality\\\":\\\"MU\\\",\\\"passportNumber\\\":\\\"78u\\\",\\\"travellerType\\\":\\\"RESIDENT\\\",\\\"airlineName\\\":\\\"Air Mauritius\\\",\\\"flightNumber\\\":\\\"MK0241\\\",\\\"arrivalDate\\\":\\\"2020-10-13\\\",\\\"title\\\":\\\"MR\\\",\\\"lengthOfStay\\\":null,\\\"countriesVisited\\\":[\\\"AE\\\"],\\\"portOfEmbarkation\\\":\\\"\\\",\\\"fever\\\":null,\\\"soreThroat\\\":null,\\\"jointPain\\\":null,\\\"cough\\\":null,\\\"breathingDifficulties\\\":null,\\\"rash\\\":null,\\\"hadCovidBefore\\\":null,\\\"visitPurpose\\\":\\\"BUSINESS\\\",\\\"mobilePhone\\\":\\\"+23057789383\\\",\\\"fixedPhone\\\":\\\"+2304600133\\\",\\\"email\\\":\\\"pmohabeer@govmu.org\\\",\\\"nationalID\\\":\\\"09087666657456G\\\",\\\"permanentAddress\\\":{\\\"hotelName\\\":null,\\\"numberAndStreet\\\":\\\"Rosehill\\\",\\\"apartmentNumber\\\":\\\"\\\",\\\"city\\\":\\\"\\\",\\\"stateProvince\\\":\\\"\\\",\\\"country\\\":\\\"MU\\\",\\\"zipPostalCode\\\":\\\"\\\"},\\\"temporaryAddress\\\":{\\\"hotelName\\\":\\\"Civic\\\",\\\"numberAndStreet\\\":\\\"camp\\\",\\\"apartmentNumber\\\":\\\"\\\",\\\"city\\\":\\\"\\\",\\\"stateProvince\\\":\\\"\\\",\\\"country\\\":\\\"MU\\\",\\\"zipPostalCode\\\":null},\\\"emergencyContact\\\":{\\\"lastName\\\":\\\"Mohabeer\\\",\\\"firstName\\\":\\\"priya\\\",\\\"address\\\":\\\"Royal Road Mare Tabac\\\",\\\"country\\\":\\\"MU\\\",\\\"mobilePhone\\\":\\\"+23057582994\\\"},\\\"familyTravelCompanions\\\":[],\\\"nonFamilyTravelCompanions\\\":[],\\\"acceptedTerms\\\":true}\"}";
    ...
    try {
      ...
      if (task.isPresent() && !GenericValidator.isBlankOrNull(task.get().getDescription())) {
        ...
        try {
          ...
          JSONArray jFamilyTravelCompanions =
              new JSONArray(jDescription.get("familyTravelCompanions").toString());
          JSONArray jNonFamilyTravelCompanions =
              new JSONArray(jDescription.get("nonFamilyTravelCompanions").toString());

          convertJSONToCSV(
              new JSONObject(task.get().getDescription()),
              LOCATOR_FORM_PROPERTY_NAME,
              valueRow,
              jFamilyTravelCompanions,
              jNonFamilyTravelCompanions);
      ...
      for (String key : jsonObject.keySet()) {
        if (!key.equalsIgnoreCase(keyMatch)) { // skip
          ...
          if (jsonObject.get(key) == null) {
            String columnName = getCreateColumnName(keyPrefix, ".", key);
            valueRow.put(columnName, EMPTY_VALUE);
          } else if (!(key.equalsIgnoreCase("permanentAddress")
              || key.equalsIgnoreCase("temporaryAddress")
      ...
      for (String key : jsonObject.keySet()) {
        if (!key.equalsIgnoreCase(keyMatch)) { // skip
          ...
          if (jsonObject.get(key) instanceof JSONObject
              && (key.equalsIgnoreCase("permanentAddress")
                  || key.equalsIgnoreCase("temporaryAddress"))) {
            convertJSONToCSV(
                jsonObject.getJSONObject(key), keyPrefix + "." + key, valueRow, keyMap);
          }
        }
      }
    }
