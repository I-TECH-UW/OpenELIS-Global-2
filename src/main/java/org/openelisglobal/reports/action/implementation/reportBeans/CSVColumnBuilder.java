...
public abstract class CSVColumnBuilder {
  ...
  protected enum SQLConstant {
    ARV_TREATMENT_ADV_EFF_GRD("arvTreatmentAdvEffGrd"),
    ARV_TREATMENT_ADV_EFF_TYPE("arvTreatmentAdvEffType"),
    COTRIMOXAZOLE_TREAT_ADV_EFF_GRD("cotrimoxazoleTreatAdvEffGrd"),
    COTRIMOXAZOLE_TREAT_ADV_EFF_TYPE("cotrimoxazoleTreatAdvEffType"),
    CURRENT_ARV_TREATMENT_INNS("currentARVTreatmentINNs"),
    CURRENT_DISEASE_OTHER("currentDiseaseOther"),
    CURRENT_DISEASES("currentDiseases"),
    DEMO("demo"),
    FUTURE_ARV_TREATMENT_INNS("futureARVTreatmentINNs"),
    ORGANIZATION("organization"),
    PRIOR_ARV_TREATMENT_INNS("priorARVTreatmentINNs"),
    PRIOR_DISEASE_OTHER("priorDiseaseOther"),
    PRIOR_DISEASES("priorDiseases"),
    RESULT("result");
  ...
  public enum Strategy {
    ...
    SAMPLE_STATUS,
    PROJECT,
    LOG, // results is a real number, but
  ...
  private synchronized java.util.Date parseDateTimeForDatabaseSql(String date)
  ...
  public String getValue(CSVColumn column, String accessionNumber)
  ...
  public class CSVColumn {
    ...
    public CSVColumn(
        String dbName, String csvName, Strategy strategy, ICSVColumnCustomStrategy customStrategy) {
      this.csvName = csvName;
      this.dbName = dbName;
      this.strategy = strategy;
    ...
    private String findMultiSelectItemsForTest(String testId) throws SQLException {
      ...
      for (Result result : results) {
        multi.append(
            ResourceTranslator.DictionaryTranslator.getInstance().translateRaw(result.getValue()));
        multi.append(",");
      }
