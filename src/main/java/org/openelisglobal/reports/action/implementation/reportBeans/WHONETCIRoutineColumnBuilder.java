...
import static org.openelisglobal.reports.action.implementation.reportBeans.WHONETCSVRoutineColumnBuilder.Strategy.AGE_MONTHS;
import static org.openelisglobal.reports.action.implementation.reportBeans.WHONETCSVRoutineColumnBuilder.Strategy.AGE_WEEKS;
import static org.openelisglobal.reports.action.implementation.reportBeans.WHONETCSVRoutineColumnBuilder.Strategy.AGE_YEARS;
import static org.openelisglobal.reports.action.implementation.reportBeans.WHONETCSVRoutineColumnBuilder.Strategy.DATE;
import static org.openelisglobal.reports.action.implementation.reportBeans.WHONETCSVRoutineColumnBuilder.Strategy.DATE_TIME;
//import static org.openelisglobal.reports.action.implementation.reportBeans.CSVRoutineColumnBuilder.Strategy.GENDER;
//import static org.openelisglobal.reports.action.implementation.reportBeans.CSVRoutineColumnBuilder.Strategy.LOG;
import static org.openelisglobal.reports.action.implementation.reportBeans.WHONETCSVRoutineColumnBuilder.Strategy.NONE;
import static org.openelisglobal.reports.action.implementation.reportBeans.WHONETCSVRoutineColumnBuilder.Strategy.PROGRAM;
//import static org.openelisglobal.reports.action.implementation.reportBeans.CSVRoutineColumnBuilder.Strategy.PROJECT;
import static org.openelisglobal.reports.action.implementation.reportBeans.WHONETCSVRoutineColumnBuilder.Strategy.SAMPLE_STATUS;
...
public abstract class WHONETCIRoutineColumnBuilder extends WHONETCSVRoutineColumnBuilder {
    ...
    protected static final String WHONET_SELECT = 
//            "SELECT t.id,t.method_id,t.uom_id,t.description,t.loinc,t.reporting_description,"
//            + "t.sticker_req_flag , t.is_active , t.active_begin , t.active_end , t.is_reportable,"
//            + "t.time_holding,t.time_wait,t.time_ta_average,t.time_ta_warning,t.time_ta_max,"
//            + "label_qty,t.lastupdated,t.label_id,t.test_trailer_id,"
//            + "t.test_section_id,t.scriptlet_id,t.test_format_id,t.local_code,t.sort_order,"
//            + "t.name,t.orderable,t.guid,t.name_localization_id,"
//            + "t.reporting_name_localization_id,t.default_test_result_id,t.notify_results,"
//            + "t.in_lab_only,t.antimicrobial_resistance " 
//            + "FROM test t WHERE t.antimicrobial_resistance = true"
//            + "\n ";
    
    "select s.accession_number,pe.last_name, pe.first_name,t.id,t.description,t.loinc,t.guid"
    + " from analysis a"
     ...
     */
    protected static final String FROM_SAMPLE_PATIENT_ORGANIZATION = " FROM sample as s, patient as pat, person as per, sample_human as sh, requester_type AS rq, sample_requester AS sq, organization AS o \n ";
    ...
    protected void defineBasicColumns() {
        ...
        add("id", "ID", NONE);
        add("description", "Description", NONE);
        add("loinc", "LOINC", NONE);
        add("guid", "GUID", NONE);
        
        /*
         * add("accession_number", "LABNO", NONE); add("national_id", "IDENTIFIER",
         * NONE); add("gender", "SEX", NONE); add("birth_date", "BIRTHDATE", DATE);
         * add("entered_date", "AGEYEARS", AGE_YEARS); add("entered_date", "AGEMONTHS",
         * AGE_MONTHS); add("entered_date", "AGEWEEKS", AGE_WEEKS); add("received_date",
         * "DATERECPT", DATE_TIME); // reception date add("entered_date", "DATEENTERED",
         * DATE_TIME); // interview date add("collection_date", "DATECOLLECT",
         * DATE_TIME); // collection date
         */        
