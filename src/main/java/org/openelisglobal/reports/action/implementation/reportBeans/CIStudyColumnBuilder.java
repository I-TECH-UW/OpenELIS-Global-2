...
public abstract class CIStudyColumnBuilder extends CSVColumnBuilder {
     ...
     */
    protected static final String FROM_SAMPLE_PATIENT_ORGANIZATION = " FROM patient as pat, person as per, sample_human as sh, sample_projects AS sp, sample_organization AS so, organization AS o \n ";
