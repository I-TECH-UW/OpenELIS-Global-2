...
public abstract class NonConformityByLabno extends Report implements IReportCreator {
  ...
  protected ObservationHistoryTypeService observationTypeService =
  ...
  protected void createReportParameters() throws IllegalStateException {
    ...
    if (ConfigurationProperties.getInstance()
        .isPropertyValueEqual(Property.configurationName, "CI_GENERAL")) {
  ...
  private void createReportItems() {
    ...
    for (Sample sample : samples) {
      ...
      data.setAge(
          DateUtil.getCurrentAgeForDate(patient.getBirthDate(), sample.getCollectionDate()));
  ...
  protected String getObservationValues(String observationTypeId) {
    List<ObservationHistory> observationList =
        observationService.getAll(patient, sample, observationTypeId);
