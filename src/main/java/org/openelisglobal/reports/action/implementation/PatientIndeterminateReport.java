...
public abstract class PatientIndeterminateReport extends RetroCIPatientReport {
  ...
  protected void setPatientInfo(IndeterminateReportData data) {
    ...
    data.setReceivedDate(
        reportSample.getReceivedDateForDisplay() + " " + reportSample.getReceivedTimeForDisplay());
  ...
  private void setIndeterminateData(
      IndeterminateReportData data, String testName, String resultValue) {
