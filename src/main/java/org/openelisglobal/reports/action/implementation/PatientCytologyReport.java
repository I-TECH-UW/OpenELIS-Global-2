...
public class PatientCytologyReport extends PatientProgramReport {
  ...
  protected CytologyDisplayService cytologySampleService =
      SpringContext.getBean(CytologyDisplayService.class);
  ...
  protected void innitializeSample(ReportForm form) {
    cytologySample =
        cytologySampleService.getCytologySampleWithLoadedAttributes(
