...
public class TestSegmentedExportBean {
  ...
  private static final String header =
      "CODSITE,LNSPID,FIRSTNAME,LASTNAME,SEX,DOB,AGE,SPECIMENID,STATUT,SPECIMEN,COLLECTDATE,COLLECTTIME,RECEIPTDATE,RECEIPTTIME,SPECIMEN_PROVENANCE,DEPARTEMENT,CATEGORIE,TEST,RESULTAT,RESULTDATE,NOTES";
  private static final String depersonalizedeader =
      "SPECIMEN,COLLECTDATE,COLLECTTIME,RECEIPTDATE,RECEIPTTIME,SPECIMEN_PROVENANCE,DEPARTEMENT,CATEGORIE,TEST,RESULTAT,RESULTDATE,NOTES";
