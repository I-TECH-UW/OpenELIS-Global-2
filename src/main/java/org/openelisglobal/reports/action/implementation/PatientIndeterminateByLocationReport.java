...
public class PatientIndeterminateByLocationReport extends PatientIndeterminateReport
  ...
  /**
   * @see
   *     org.openelisglobal.reports.action.implementation.PatientIndeterminateReport#createReportItems()
   */
  @Override
  protected void createReportItems() {
    List<SampleProject> sampleProject =
        sampleProjectService.getByOrganizationProjectAndReceivedOnRange(
            locationStr, "Indeterminate Results", dateRange.getLowDate(), dateRange.getHighDate());
