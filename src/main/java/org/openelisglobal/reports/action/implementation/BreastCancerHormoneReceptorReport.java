...
public class BreastCancerHormoneReceptorReport extends PatientProgramReport {
  ...
  private List<Analysis> getAnalysesByTestAndSampleAndStatus(
      Sample sample, Test test, Set<Integer> statusIdList) {
    ...
    List<Analysis> analyses =
        analysisService.getAnalysesBySampleIdTestIdAndStatusId(
            sampleIdList, testIdList, new ArrayList<>(statusIdList));
