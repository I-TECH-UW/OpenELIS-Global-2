...
public class NameValidator
    implements ConstraintValidator<ValidName, String>, ConfigurationListener {
        ...
        "(?iu)^["
            + escapeRegexChars(
                siteInformationService
                    .getMatch("name", "firstNameCharset")
                    .orElse(DEFAULT_SITE_INFORATION)
                    .getValue())
            + "]*$";
    LAST_NAME_REGEX =
        "(?iu)^["
