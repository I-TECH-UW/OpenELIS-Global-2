...
@Component
@Transactional
public class CityStateZipDAOImpl extends BaseDAOImpl<CityStateZip, String>
    implements CityStateZipDAO {
  ...
  public List<CityStateZip> getCities(String filter) throws LIMSRuntimeException {
    ...
    try {
      String sql =
          "from CityView csz where upper(csz.city) like upper(:param) order by upper(csz.city)";
  ...
  public List<CityStateZip> getZipCodesByCity(CityStateZip cityStateZip)
    ...
    try {
      ...
      String sql =
          "select distinct csz.zipCode, csz.city from CityStateZip csz where upper(csz.city) ="
              + " :param";
  ...
  public List<CityStateZip> getCitiesByZipCode(CityStateZip cityStateZip)
    ...
    try {
      String sql =
          "select distinct csz.city, csz.zipCode from CityStateZip csz where csz.zipCode = :param";
      Query<?> query = entityManager.unwrap(Session.class).createQuery(sql);
  ...
  public List<CityStateZip> getAllStateCodes() throws LIMSRuntimeException {
    ...
    try {
      ...
      String sql =
          "select distinct upper(csz.state) from CityStateZip csz order by upper(csz.state)";
      Query<?> query = entityManager.unwrap(Session.class).createQuery(sql);
      List list = query.list();
  ...
  public CityStateZip getCityStateZipByCityAndZipCode(CityStateZip cityStateZip)
    ...
    try {
      String sql =
          "from CityStateZip csz where upper(csz.city)) = :param and csz.zipCode = :param2";
      Query<CityStateZip> query =
          entityManager.unwrap(Session.class).createQuery(sql, CityStateZip.class);
      query.setParameter("param", cityStateZip.getCity().trim().toUpperCase());
  ...
  public CityStateZip getState(CityStateZip cityStateZip) throws LIMSRuntimeException {
    ...
    try {
      String sql =
          "select distinct csz.state from CityStateZip csz where upper(csz.state) = :param";
      Query<?> query = entityManager.unwrap(Session.class).createQuery(sql);
  ...
  public CityStateZip getZipCode(CityStateZip cityStateZip) throws LIMSRuntimeException {
    ...
    try {
      String sql =
          "select distinct csz.zipCode from CityStateZip csz where upper(csz.zipCode) = :param";
      Query<?> query = entityManager.unwrap(Session.class).createQuery(sql);
  ...
  public boolean isCityStateZipComboValid(CityStateZip cityStateZip) throws LIMSRuntimeException {
    ...
    try {
      ...
      if (!StringUtil.isNullorNill(state)
        ...
        sql =
            "select distinct csz.zipCode, csz.city, csz.state from CityStateZip csz where"
                + " upper(csz.city) = :param and csz.zipCode = :param2 and upper(csz.state) ="
                + " :param3";
        Query<?> query = entityManager.unwrap(Session.class).createQuery(sql);
        query.setParameter("param", cityStateZip.getCity().trim().toUpperCase());
        ...
        list = query.list();
          ...
          && StringUtil.isNullorNill(zipCode)) {
        sql =
            "select distinct csz.city, csz.state from CityStateZip csz where upper(csz.city) ="
        ...
        list = query.list();
          ...
          && !StringUtil.isNullorNill(zipCode)) {
        sql =
            "select distinct csz.zipCode, csz.state from CityStateZip csz where csz.zipCode ="
        ...
        query.setParameter("param2", cityStateZip.getZipCode().trim().toUpperCase());
        list = query.list();
      } else if (StringUtil.isNullorNill(city)
          && StringUtil.isNullorNill(zipCode)
  ...
  public List<CityStateZip> getValidCityStateZipCombosForHumanSampleEntry(CityStateZip cityStateZip)
    ...
    try {
      ...
      if (!StringUtil.isNullorNill(state)
        ...
        // now get all where zip matches
        sql =
            "select distinct csz.zipCode, csz.city from CityStateZip csz where csz.zipCode ="
        ...
        for (int i = 0; i < listByZip.size(); i++) {
          ...
          && !StringUtil.isNullorNill(zipCode)) {
        sql =
            "select distinct csz.state, csz.zipCode from CityStateZip csz where csz.zipCode ="
  ...
  private CityStateZip setCityStateZipValueholder(
      CityStateZip csz, String city, String state, String zip) {
