...
@Service
public class SampleOrganizationServiceImpl
    extends AuditableBaseObjectServiceImpl<SampleOrganization, String>
    implements SampleOrganizationService {
  @Autowired protected SampleOrganizationDAO baseObjectDAO;
