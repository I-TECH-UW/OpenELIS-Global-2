...
public class SampleBatchEntryRestController extends BaseController {
   ...
   @PostMapping(value = "/SampleBatchEntry", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public SampleBatchEntryForm showSampleBatchEntry(HttpServletRequest request,
        @RequestBody SampleBatchEntryForm form, BindingResult result,RedirectAttributes redirectAttributes) throws DocumentException {
