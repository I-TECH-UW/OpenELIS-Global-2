...
public class SampleBatchEntryController extends BaseController {
  ...
  public ModelAndView showSampleBatchEntry(
      HttpServletRequest request,
      @ModelAttribute("form") @Valid SampleBatchEntryForm form,
  ...
  public @ResponseBody ModelAndView showSamplePatientEntrySave(
      HttpServletRequest request,
      @ModelAttribute("form") @Validated(SamplePatientEntryForm.SamplePatientEntryBatch.class)
