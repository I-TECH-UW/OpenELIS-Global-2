	...
	private LabelValuePair processLabelValue(String fieldName, String propertyPreUpdateState, Object existingObject,
		...
		if (propertyPreUpdateState.startsWith("{us.mn.state.health.lims")) {
			if (fieldName.equals("test")) {
				...
				// testreflex
				try {
					us.mn.state.health.lims.testreflex.valueholder.TestReflex data = (us.mn.state.health.lims.testreflex.valueholder.TestReflex) existingObject;

					us.mn.state.health.lims.testreflex.valueholder.TestReflex data2 = (us.mn.state.health.lims.testreflex.valueholder.TestReflex) newObject;
