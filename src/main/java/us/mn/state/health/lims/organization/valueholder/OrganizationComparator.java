...
public class OrganizationComparator implements Comparable<Organization> {
   ...
   public static final Comparator<Organization> NAME_COMPARATOR =
   ...
   public static final Comparator<Organization> SHORTNAME_NUMERIC_COMPARATOR =
       new Comparator<Organization>() {
   ...
   /**
    *  The NAME_COMPARATOR claims to compare by name, but it actually looks at ID (and its used). This one does it by the OrganizationName field. 
    */
   public static final Comparator<Organization> ORGANIZATION_NAME_COMPARATOR =
       new Comparator<Organization>() {
           public int compare(Organization o1, Organization o2) {
