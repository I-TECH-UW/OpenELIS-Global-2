...
*/
package us.mn.state.health.lims.hibernate.resources.interceptor;
 ...
 * this interceptor is registered in HibernateUtil (it is a global interceptor)
 * 
 * originally designed to trim leading and trailing spaces from a string
 * bugzilla 2109 added trimming of spaces embedded in a string (replace multiple spaces with 1 space)
 */
public class LIMSTrimDataInterceptor extends EmptyInterceptor {
   ...
   //for inserts all strings should be trimmed
	...
	//for updates only if entity isDirty and a particular property of type string has changed should trim occur
