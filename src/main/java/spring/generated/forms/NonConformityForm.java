...
public class NonConformityForm extends BaseForm {
  ...
  private Collection qaEvents;

  private String section = "";

  private Collection sections;

  private Collection qaEventTypes;

  private Collection typeOfSamples;
  ...
  public String getSampleItemsTypeOfSampleIds() {
    return this.sampleItemsTypeOfSampleIds;
  }
  ...
  public Collection getQaEvents() {
    return this.qaEvents;
  }

  public void setQaEvents(Collection qaEvents) {
  ...
  public Collection getQaEventTypes() {
    return this.qaEventTypes;
  }

  public void setQaEventTypes(Collection qaEventTypes) {
    this.qaEventTypes = qaEventTypes;
  }

  public Collection getTypeOfSamples() {
    return this.typeOfSamples;
  }

  public void setTypeOfSamples(Collection typeOfSamples) {
  ...
  public String getProviderStreetAddress() {
    return this.providerStreetAddress;
  }
  ...
  public String getProviderDepartment() {
    return this.providerDepartment;
  }
