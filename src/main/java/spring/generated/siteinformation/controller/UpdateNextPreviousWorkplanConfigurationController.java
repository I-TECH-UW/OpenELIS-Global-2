...
@Controller
public class UpdateNextPreviousWorkplanConfigurationController extends BaseController {
  @RequestMapping(
      value = "/UpdateNextPreviousWorkplanConfiguration",
      method = RequestMethod.GET
  )
  public ModelAndView showUpdateNextPreviousWorkplanConfiguration(HttpServletRequest request,
