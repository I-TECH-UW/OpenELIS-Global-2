  ...
  <xsl:template match="/">
   ...
   <xsl:template match="patient">
     <xsl:if test="count(person) != 0"> 
       <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'patient.personId')"/>
      </td>
      <td width="33%">      
      <i>
      ...
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'patient.race')"/>
      </td>
      <td width="33%">
       <i>
     ...
     <xsl:if test="count(gender) != 0">
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'patient.gender')"/>
      </td>
      <td width="33%">
       <i>
     ...
     <xsl:if test="count(birthDateForDisplay) != 0">
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'patient.birthDate')"/>
      </td>
      <td width="33%">
       <i>
     ...
     <xsl:if test="count(birthTimeForDisplay) != 0">
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'patient.birthTime')"/>
      </td>
      <td width="33%">
       <i>
      ...
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'patient.deathDate')"/>
      </td>
      <td width="33%">
       <i>
     ...
     <xsl:if test="count(epiFirstName) != 0">
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'patient.epiFirstName')"/>
      </td>
      <td width="33%">
       <i>
     ...
     <xsl:if test="count(epiMiddleName) != 0">
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'patient.epiMiddleName')"/>
      </td>
      <td width="33%">
       <i>
     ...
     <xsl:if test="count(epiLastName) != 0">
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'patient.epiLastName')"/>
      </td>
      <td width="33%">
       <i>
      ...
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'patient.nationalId')"/>
      </td>
      <td width="33%">
       <i>
      ...
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'patient.ethnicity')"/>
      </td>
      <td width="33%">
       <i>
      ...
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'patient.schoolAttend')"/>
      </td>
      <td width="33%">
       <i>
     ...
     <xsl:if test="count(medicareId) != 0">
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'patient.medicareId')"/>
      </td>
      <td width="33%">
       <i>
     ...
     <xsl:if test="count(medicaidId) != 0">
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'patient.medicaidId')"/>
      </td>
      <td width="33%">
       <i>
    ...
    <xsl:if test="count(birthPlace) != 0">
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'patient.birthPlace')"/>
      </td>
      <td width="33%">
       <i>
     ...
     <xsl:if test="count(externalId) != 0">
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'patient.externalId')"/>
      </td>
      <td width="33%">
       <i>
     ...
     <xsl:if test="count(chartNumber) != 0">
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'patient.chartNumber')"/>
      </td>
      <td width="33%">
       <i>
