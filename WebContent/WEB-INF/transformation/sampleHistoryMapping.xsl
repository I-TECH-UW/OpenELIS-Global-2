...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:java="http://www.oracle.com/XSL/Transform/java">
  ...
  <xsl:template match="sample">
     <xsl:if test="count(accessionNumber) != 0"> 
       <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'sample.accessionNumber')"/>
      </td>
      <td width="33%">      
      <i>
      ...
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'sample.collectionDate')"/>
      </td>
      <td width="33%">
      <i>
      ...
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'sample.collectionTime')"/>
      </td>
      <td width="33%">
      <i>
      ...
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'sample.clientReference')"/>
      </td>
      <td width="33%">
       <i>
      ...
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'sample.domain')"/>
      </td>
      <td width="33%">
      <i>
     ...
     <xsl:if test="count(packageId) != 0"> 
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'sample.packageId')"/>
      </td>
      <td>
      <i>
      ...
      <tr>
      <td width="33%">
        <xsl:value-of select="java:getString($resources,'sample.revision')"/>
      </td>
      <td width="33%">
      <i>
      ...
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'sample.enteredDateForDisplay')"/>
      </td>
      <td width="33%">
      <i>
      ...
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'sample.receivedDateForDisplay')"/>
      </td>
      <td width="33%">
      <i>
      ...
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'sample.releasedDateForDisplay')"/>
      </td>
      <td width="33%">
      <i>
      ...
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'sample.stickerReceivedFlag')"/>
      </td>
      <td width="33%">
      <i>
      ...
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'sample.sysUserId')"/>
      </td>
      <td width="33%">
      <i>
      ...
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'sample.transmissionDate')"/>
      </td>
      <td width="33%">
      <i>
      ...
      <tr>
      <td width="33%">
       <xsl:value-of select="java:getString($resources,'sample.referredCultureFlag')"/>
      </td>
      <td width="33%">
       <i>
