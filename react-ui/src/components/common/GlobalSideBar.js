...
import {Content, SideNav, SideNavItems, SideNavMenu, SideNavMenuItem} from "@carbon/react";
                                            ...
                                            item.SideNavMenuItem.map((subItem,subIndex)=>{
                                                  return (
                                                      <div key={index+"_"+subIndex}>
                                                          <SideNavMenuItem key={index+"_"+subIndex} href={subItem.link} >{subItem.label}</SideNavMenuItem>
                                                      </div>
                                                  )
                                            })
                                        }
