    ...
    sideNavMenuItems: [
        {
            ...
            SideNavMenuItem: [
                {
                    link: config.serverBaseUrl +"/ResultValidationRetroC?type=Immunology&test=",
        ...
        },
        {
            ...
            SideNavMenuItem: [
                {
                    link: config.serverBaseUrl +"/ResultValidationRetroC?type=Biochemistry&test=",
                    label: "Biochemistry"
                }
            ]
        },
        ...
        },
        {
            ...
            SideNavMenuItem: [
                {
                    link: config.serverBaseUrl +"/ResultValidationRetroC?type=virology&test=DNA PCR",
                    label: "DNA PCR"
                }, {
                    link: config.serverBaseUrl +"/ResultValidationRetroC?type=virology&test=Viral Load",
                    label: "Viral Load"
                }, {
                    link: config.serverBaseUrl +"/ResultValidationRetroC?type=virology&test=Genotyping",
                    label: "Genotyping"
                }
            ]
        }
