...
└── Dockerfile    // contains necessary commands and procedures to build base prod docker images for the project.
└── Docker-compose.yml  // contains necessary commands and  steps to build multiple services.
...
It is highly recommended to rebuild the application and make sure your test cases are passing before opening any pull request.
...
OpenELIS Global works well with Java 11  , if you have a different java version you can download the  [Java 11 ](https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html) and set your JAVA_HOME to point to 11.
...
#### Thank you for your kind attention to this, Let's build some cool stuff together.
